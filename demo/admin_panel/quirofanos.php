...
<!--<div class=" row">
 ...
 <div class="row">
    <div class="box col-md-12">
        <div class="box-inner quirofanos-table">
            <div class="box-header well">
                <h2 style="width: 90px;">
					<li><a href="#" >TO PRINT</a>
				</h2>
				<h2>
					<li><a href="quirofanos" >REFRESH PAGE</a>
				</h2>
			...
			<div style="height: 69px;" class="quirofanos-search-box">
					<table align="center">
						<tr>
							<td>Speciality : </td>
			...
			<div class="quirofanos-slected-date">SELECT DATE : <input type="text" name="date" id="datepicker"></div>
	  
				<div>
				<b style="text-decoration: underline;"> SCHEDULED: </b>
				...
				<div >
				<b style="text-decoration: underline;">WITHOUT:</b>
				<table border="1" width="100%">
					<tr>
						<th>CLINIK</th>
						<th>HOUR</th>
