...
//  			}
//  		}
//  		gigDeets_xhr.open('get','https://www.stage.gospelscout.com/gigmanager/phpBackend/connectToDb.php?eventTable='+eventTable+'&rowEntryID='+rowEntryID);
//  		gigDeets_xhr.send();
//  });
/*************************************
	...
	/* User confirms and sends Response */
		$('#send_art_response').click(function(event){
			/* Send Artist response to db */
				...
				art_response_xhr.open('post','https://www.stage.gospelscout.com/gigmanager/phpBackend/connectToDb.php');
      ...
      /**** Create function for xml http request ****/
        function useBackbone(getVar,newLocal){
          ...
          /* New XML Http Request */
            ...
            queryBackbone.open('GET','https://www.stage.gospelscout.com/views/xmlhttprequest/notificationBackbone.php?'+getVar);
            queryBackbone.send()
        }
