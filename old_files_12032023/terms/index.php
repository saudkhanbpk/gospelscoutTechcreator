	...
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-lg-12" style="text-align: left; font-size:14px">
			<!-- Terms & Conditions Intro -->
				<p><b>Please read these Terms of Use carefully before using the <a class="text-gs" href="https://www.gospelscout.com" target="_blank">https://www.gospelscout.com</a> website operated by GospelScout.</b></p>
			...
			<!-- Google Calenar -->
				...
				<ol>
					...
					<li>GospelScout can refresh permissions to access my Google calendar data, through the use of refresh tokens, until I explicitly un-link my Google Calendar from my GospleScout profile, via my <a href="https://www.gospelscout.com/calendar/?u_Id=<?php echo $currentUserID;?>" target="_blank">fullcalendar page</a>, or until I remove my GospelScout profile all together. </li>
				</ol>
			<!-- /Google Calenar -->
