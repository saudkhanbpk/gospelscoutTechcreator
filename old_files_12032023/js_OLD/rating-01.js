...
(function(a){
    a.fn.codexworld_rating_widget01 = function(p){
        var p = p||{};
        ...
        b = parseInt(b);
        init();
        g.next("ul0").children("li").hover(function(){
        ...
        g.next("ul01").hover(function(){},function(){
            if(f == ""){
        ...
        function init(){
            ...
            g.css("float","left");
            var a = $("<ul>");
            a.addClass("codexworld_rating_widget01");
            for(var i=1;i<=b;i++){
