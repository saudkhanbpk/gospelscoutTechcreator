...
<div class="ch-container">
    ...
    <ul class="breadcrumb">
        <li>
            <a href="medical_histry.php">MEDICAL HISTORY</a>
        </li>
 ...
 <div class="row">
    <div class="box col-md-12">
        <div class="box-inner" style="width: 100%;float: left;">
			...
			<div>
			<div class="medical-histry-table">
				<div style="width: 60px;margin-top: -20px;"><b>PATIENT:</b></div>
				<div class="medical-serch-box"> <form id="lets_search" action=""><input type="text" name="str" id="str"><input type="text" name="str1" id="str1" > <input type="text" name="str2" id="str2"><input type="submit" value="Search" name="send" id="send"></form></div>
				<div class="medical-histry-table1" id="search_results">
				...
				<div class="medical-histry-table2"></div>
				
				
			</div>
			<div><input type="submit" value="CLINIC&#13;&#10;HISTORY" style="padding: 30px 20px;margin-left: 28px;">
					<input type="submit" value="PERSONAL&#13;&#10;INFORMATION" style="padding: 30px 20px;margin-left: 28px;">
					<input type="submit" value="ACTIVITY&#13;&#10;PERFORMED" style="padding: 30px 20px;margin-left: 28px;">
					<input type="submit" value="HISTORY AUDIT" style="padding: 8px 20px;margin-left: 28px;">
			</div>
