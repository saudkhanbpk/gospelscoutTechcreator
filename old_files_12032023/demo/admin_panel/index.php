...
if(isset($_POST['submit2']))
	{
		...
		$querys1=mysql_query("delete from patient_add where time ='$hidden1'");
...
<div class="ch-container">
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="configuration.php"><img style="padding-right:8px" src="img/CONFIGURATIONS.png"></i><span>CONFIGURATIONS</span></a>
                        </li>
					</ul>
    ...
    <ul class="breadcrumb">
        <li>
            <a href="index.php">ETERNAL CONSULTATIONS</a>
        </li>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2 style="width: 90px;">
					<li><a href="#" data-toggle="modal" data-target="#myModal">TO PRINT</a>	
				...
				<h2>
					<li><a href="index" >REFRESH PAGE</a>
				</h2>
			...
			<div>
			<div style="height: 69px;" class="index-speciality">
					<table align="center">
						<tr>
							<td>Speciality : </td>
...
mysql_select_db('gospelsc_db663107335',$con);
							...
							<td>Diary : </td>
							<td><select name="dropdown1" id="wrd">
			...
			<div class="modify-table"><input type="submit" data-toggle="modal" data-target="#myModal1" value="ADD">
											<input type="submit" value="MODIFY">

					<form method="POST" action="" style="float: right;margin-right: 74px;">
	  		...
	  		<div class="index-slect-date">SELECT DATE : <input type="text" name="date" id="datepicker"></div>

		
				<div class="index-table" id="results01" >
...
mysql_select_db('gospelsc_db663107335',$con);
								...
								?>
					<tr>
						<td contenteditable><?php echo $rows['time'];?></td>
						<td contenteditable><?php echo $rows['first_name'];?></td>
						<td contenteditable><?php echo $rows['p_catagery'];?></td>
						<td contenteditable><?php echo $rows['vtype'];?></td>
						<td contenteditable>NO</td>
						<td contenteditable><?php echo $rows['telephone'];?></td>
        ...
        <div class="modal-content">
			...
			<div style="margin:20px;border: 1px solid black;height: 300px;">
				...
				<div style="float: left;height: 200px;border: 1px solid black;width: 490px;margin-left: 10px;" id="search_results">
						...
						<input type="submit" data-toggle="modal" data-target="#myModal2" style="margin-left: 161px;margin-top: 30px;"  Value="NEW PATIENT">
				</div>
				<div style="float: left;margin-left: 527px;border: 1px solid black;margin-top: -200px;height: 233px;width: 263px;"></div>
...
<div id="myModal2" class="modal fade">
    <div class="modal-dialog" style="width: 737px !important;">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
					...
					<form method="POST" action="urgencias.php" id="myForm3">
						...
						<table width="100%">
							...
							<tr>
								<td style="width: 117px;">SELECT HOURS :</td>
								<td><input type="text" name="time" id="timepicker1" style="width: 175px;" ></td>
							</tr>
							<tr>
								<td style="width: 111px;">SURNAME :</td>
								<td><input type="text" name="sname" id="psname" style="width: 175px;" ></td>
...
function SubmitFormData1() {
    ...
    $.post("insertdata.php", { timepicker1: timepicker1, psname: psname, psname1: psname1, pfname: pfname, pdni: pdni, pbdate: pbdate, dropdown4: dropdown4, pdoa: pdoa, responsable: responsable, pdiagnosis: pdiagnosis, ptriatge: ptriatge, pbox: pbox, vtype: vtype,  paddress: paddress, ppopulation: ppopulation, ppostalcode: ppostalcode, ptelephone: ptelephone, psms: psms, pradio: pradio, prole1: prole1, pnote: pnote  },
    function(data) {
	$('#results01').html(data);
	 $('#myForm')[0].reset();
    });
