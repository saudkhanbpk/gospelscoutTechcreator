...
// exit;
	...
	if(count($newCriteriaArray) !== 0 && $newCriteriaArray !== null){	
		/*************************************** Define the Query Statement ***************************************/
			...
			if($trigger == 1){
				$artistSearchQuery .= " FROM talentmaster 
									    INNER JOIN usermaster on talentmaster.iLoginID = usermaster.iLoginID
									    INNER JOIN states on usermaster.sStateName = states.id
...
// exit;
		...
		/************************** Query the database for based on the search criteria ***************************/
			try{
								...
								<div class="col col-md-3 px-md-1 px-lg-4 my-2">
									...
									<!-- /link to artist's profile pic -->
									  ...
									  <div class="card-footer p-0 pt-1 text-center">
									    	<a href="<?php echo URL;?>newHomePage/views/artistprofile.php?artist=<?php echo $groupArtist['iLoginID'];?>" class="btn mb-0 btn-primary btn-sm btn-gs">View Profile</a><!-- link to the artist's profile -->
									  	</div>
									</div> 
								</div>
							<?php }?>
...
<?php 
			...
			echo 'Sorry, there are currently no matching this criteria.';
		}
	}
	else{
?>
		...
		<div class="container d-sm-none">
			...
			?>
			  	...
			  	<div class="container" id="<?php echo $talContainerTitle;?>"> 
					  ...
					  <div class="carousel-inner pb-0 mb-0 " style="height: 250px;padding-left:100px  ">				   
					  	<!-- Carousel Slide -->
						  	<!-- Determine # of slides -->
							  	<?php 
							    		...
							    		?>
									    	...
									    	<div class="card p-2 mb-0" style="width: 175px;margin:auto">
											  ...
											  <div class="card-footer p-0 pt-1 text-center mt-0">
											    <a href="#" class="btn btn-primary btn-sm btn-gs">View Profile</a>
											  </div><!-- /footer -->
											</div><!-- /Card Info -->
										<?php 
											}
							    		...
							    		?>
							    			<div class="col-3 px-4">
												...
												<!-- /link to artist's profile pic -->
												  ...
												  <div class="card-footer p-0 pt-1 text-center">
												    	<a href="<?php echo URL;?>newHomePage/views/artistprofile.php?artist=<?php echo $artistCard['iLoginID'];?>" class="btn mb-0 btn-primary btn-sm btn-gs">View Profile</a><!-- link to the artist's profile -->
												  	</div>
												</div> 
											</div>
										<?php
