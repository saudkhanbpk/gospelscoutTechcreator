                                                                 ...
                                                                 ?> 
                                                                            <!-- Card Content -->
                                                                                <div class="card col-7 p-4 col-md-2 p-md-4 border-light mx-auto mx-md-0">
                                                                                    <a href="<?php echo URL; ?>views/videoDisplay.php?vid_id=<?php echo $eachVidArray['id']; ?>&artistID=<?php echo $u_ID;?>&tal=<?php echo $TalentName; ?>">
                                                                                  ...
                                                                                  <div>
                                                                                        ...
                                                                                        <a href="#" style="display:block" data-toggle="modal" data-target="#deleteVid">Delete Video</a>
                                                                                  </div>
                                                                                </div>
                                                                            <!-- /Card Content -->
                                                                <?php   
                                          ...
                                          <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal Body -->
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="AdminId" value="">
                                                            <input type="hidden" name="artistID" value="">
                                                            <input type="hidden" name="vidID" value="">
                                                        </div>
                                                    </div>
                                                 <!-- /Modal Body -->
                                                ...
                                                <!-- Modal Footer id="exampleModalLongTitle"-->
                                                    <div class="modal-footer">
                                                        <button type="button" data-toggle="modal" data-target="#confirmVidDeletion" class="btn btn-gs" id="remVidtButton" data-dismiss="modal" aria-label="Close">Delete</button>
