 ...
 function reloadPage(){
	...
	if(url != ''){
		...
		if (url == 'artist') {
			...
			window.location.href = "http://www.gospelscout.com/views/churchprofile?church="+id;	
						
		} else{
			
			window.location.href = "http://www.gospelscout.com/views/userprofile?artist="+user;		
