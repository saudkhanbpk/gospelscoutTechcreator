                    ...
                    <div class="chat-module">
                        <div class="chat-module-top">
                            ...
                            <div class="chat-module-body">
                                ...
                                ?>      
                                        <a href="<?php echo URL;?>newHomePage/adminDashboard/concept-master/contactUs-message-details.php?id=<?php echo $indivMess['id'];?>" id="cuListing">   
                                            <div class="media chat-item">
                                                <?php 
                                                    if($indivMess['iLoginID'] == 'Visitor'){
                                                        echo '<img alt="William" src="' . URL . 'newHomePage/img/gsStickerBig1.png" class="rounded-circle user-avatar-lg aProfPic">';
                                                    }
                                                    else{
                                                        echo '<img alt="William" src="' . URL . 'newHomePage/upload/' . $indivMess['sUsertype'] . '/' . $indivMess['pic']. '" class="rounded-circle user-avatar-lg aProfPic">';
                                                    }
                                                ?>
