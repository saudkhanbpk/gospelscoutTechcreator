            ...
            ?>
              <tr>
                ...
                <td><a href="<?php echo HTTP_SERVER;?>views/userdetails.php?iLoginID=<?php echo $usermaster[$i]['iLoginID'];?>" title="View"><i class="fa fa-fw fa-eye"></i></a> | 
                    <a href="<?php echo HTTP_SERVER;?>views/viewusers.php?iLoginID=<?php echo $usermaster[$i]['iLoginID'];?>" title="Delete" onClick="return confirm('Are you sure want to delete?');"><i class="fa fa-fw fa-remove"></i></a></td>
              </tr>  
            <?php } ?>            
            </tbody>
          </table>
