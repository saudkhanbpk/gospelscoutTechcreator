                                        ...
                                        <li class="breadcrumb-item">
                                            <?php 
                                                if($userFound['isActive'] == 1){ 
                                                    echo '<a href="' . URL . 'newHomePage/adminDashboard/concept-master/manageusers-church.php?act=1" class="breadcrumb-link">';
                                                    echo 'Active Church';
                                                }else{
                                                    echo '<a href="' . URL . 'newHomePage/adminDashboard/concept-master/manageusers-churches.php?act=0" class="breadcrumb-link">';
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                            <div class="card ">
                                ...
                                <!-- Artist's profile pic -->
                                    ...
                                    <div class="container text-center text-md-left pl-md-4 mt-2">
                                        <a class="font-weight-bold text-gs" href="<?php echo URL;?>newHomePage/views/churchprofile.php?church=<?php echo $u_ID;?>">View Profile</a>
                                    </div>
                                <!-- /Artist's profile pic -->
                                <div class="card-body">
                                    <div class="container">
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class='py-3' colspan="2"><a href="<?php echo URL;?>newHomePage/adminDashboard/concept-master/adminedit-user-profile.php?u_type=<?php echo 'church';?>&id=<?php echo $u_ID;?>" class="p-2 mt-4 text-white bg-gs" style="margin-top:12px;font-size:14px;border-radius:2px">Edit Acct</a></td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <div class="container">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6 text-right">
                                                                    <a class="anchor-styled" href="<?php echo URL;?>newHomePage/views/viewAllVid.php?tal=<?php echo $TalentName;?>&churchID=<?php echo $u_ID; ?>">View All</a>
                                                                </div>
                                                            </div>
                                                            <!-- Card Rows -->
                                                            <div class="row">
                                                                 ...
                                                                 ?> 
                                                                            <!-- Card Content -->
                                                                                <div class="card col-7 p-4 col-md-2 p-md-4 border-light mx-auto mx-md-0">
                                                                                    <a href="<?php echo URL; ?>newHomePage/views/videoDisplay.php?vid_id=<?php echo $eachVidArray['id']; ?>&churchID=<?php echo $u_ID;?>&tal=<?php echo $TalentName; ?>">
