...
$(function() {
    ...
    <div class="row">
		...
		';
			...
			$txt .= 'days Ago</p>
                <a style="float: right; margin-right: -100px; color: red;" href="'.URL.'views/churchvideodetails?video='.$_GET['videoname'].'&youtube='.$_GET['youtube'].'&cat='.$_GET['cat'].'&church='.$_GET['church'].'&iCommentID='.$videocountReview[$vi]['iCommentID'].'" onclick="return confirm(Are you sure want to delete?);">X</a>
        </div>';
         } 
    $txt .= '</div>
    </div>';
