...
<script type="text/javascript" src="http://www.gospelscout.com/js/rhinoslider-1.05.min.js"></script>
...
*/
   ...
   <?php } else{ ?>
            ...
            alert('Your Registration Successful..Please Check Your Mail....');
           	window.location='http://www.gospelscout.com/views/artistprofile.php';
            </script>
   <?php  }
}    
} 
