...
/*********************************************** Video Comment Appends *************************************************/
	...
	function AppendFunct(data){
		...
		comment +=	  		'<img class="mr-3" src="'+data.sProfileName+'" width="40px" height="40px" alt="image">';
...
/*********************************************** Video COmment Replies Append *************************************************/
	...
	/* Fetch Existing Video Comment Replies & Append */
   		function AppendReply(data){
   			...
   			/* Loop to display each comment */
	   			while(data[j]){
	   				var reply = '';
				   	reply +=	'<div class="media mt-3" id="userReply_'+data[j]['icommentId']+'">';///upload/'+data[j]['usertype']+'/
				    reply +=  		'<a class="pr-3" href="#"><img src="'+data[j]['sProfileName']+'" width="40px" height="40px" alt="image"></a>';
	...
	/* Add New Video Comment Replies & Append */
   		function AppendNewReply(data){
			var reply = '';
		   	reply +=	'<div class="media mt-3" id="userReply_'+data.iCommentID+'">';///upload/'+data.usertype+'/
		    reply +=  		'<a class="pr-3" href="#"><img src="'+data.sProfileName+'" width="40px" height="40px" alt="image"></a>';
		    reply +=  		'<div class="media-body">';
