					...
					/* PROCESS UPLOADED VIDEO CONTENT */
						/**** Create correct directory corresponding to church vs artist ****/
							if($postArray['u_type'] == 'artist' || $postArray['u_type'] == 'group'){
								$vidDir = URL . 'upload/video/artist/artist_' . $_POST['iLoginID'] . '/video/'; 
								$thumbDir = URL . 'upload/video/artist/artist_' . $_POST['iLoginID'] . '/thumbnail/';
							}
							elseif($postArray['u_type'] == 'church'){
								$vidDir = URL . 'upload/video/church/church_' . $_POST['iLoginID'] . '/video/'; 
								$thumbDir = URL . 'upload/video/church/church_' . $_POST['iLoginID'] . '/thumbnail/';
							}
