					...
					if($_FILES){
						...
						elseif($_FILES['sProfileName']['error'] == 0){
							...
							/* PROCESS UPLOADED MUSIC CONTENT */
								$musicDir = '/newHomePage/upload/artist/'; 
											...
											if($upD_cust){
												...
												/* Get and store the subscription_item IDs */
													if($createSubscription['items']['data'][0]['id']){
														...
														$value1 = array($newUser['iLoginID'],$newUser['sContactEmailID'],$subscriptionID,$postGig_itemID,$bidGig_itemID,$today);
	 ...
	 <div  class="pt-5" style="width:100%; height:100%;background-color: rgba(149,73,173,.3);">
		...
		<div class="carousel-inner ">
			<div class="container px-md-5" >
				<form action="artist.php" method="post" name="artist-signup" id="artist-signup" enctype="multipart/form-data" autocomplete="off">
					<!-- Slide 1 -->
