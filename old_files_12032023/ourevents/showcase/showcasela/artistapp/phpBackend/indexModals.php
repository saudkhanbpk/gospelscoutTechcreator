          ...
          <div class="container pt-2 pb-0 mb-0" style="background-color: rgb(233,234,237);">
             <div class="row pl-0">
              <div class="col-md-10 mx-auto text-center">
                ...
                <p style="font-size:1.3em;" class="text-success font-weight-bold">Artist Submission Successful!</p>
              </div>
            </div>
          </div>
              ...
              <div class="checkbox container py-md-4 m-0"> 
                ...
                <div class="row">
                  <div class="col col-md-10 mx-auto text-left">
                    <p class="text-black" style="font-size: .8em;"><span class="art_name"></span>, thank you for your submission to the GospelScout Artist Showcase.  We value your desire to be a part of our event.  Your participation will go a long way in helping us to continue providing amazing events and supporting our local talent. We will contact you shortly!</p> 
                  </div>
                </div>
