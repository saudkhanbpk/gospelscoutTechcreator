...
getArtistSubmissions_xhr.open('get','https://www.gospelscout.com/ourevents/showcase/showcasela/artistappreview/phpBackend/connectToDb.php?getArtistSubmission=true');
...
$('#tableContainer').on('click', '.getArtist', function(e){
    ...
    // Fetch artist info
        ...
        fetchArtist.open('get',`https://www.gospelscout.com/ourevents/showcase/showcasela/artistappreview/phpBackend/connectToDb.php?fetchArtist=${submissionID}`);
        fetchArtist.send();
});
