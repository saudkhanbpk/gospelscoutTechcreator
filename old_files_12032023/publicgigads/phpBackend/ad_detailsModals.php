    ...
    <div class="modal fade" id="loseArtist" tabindex="-1" role="dialog" aria-labelledby="loseArtist" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <!-- Modal Title -->
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Cancel Artist</h5>
            ...
            <!-- Modal Body -->
                <div class="modal-body">
                    <div class="form-group">
                        <label for="vidTalent">Reason For Canceling Artist</label>
            ...
            <!-- Modal Footer -->
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger selectArtist"  artistID="" manID="" id="deselectThisArtist" data-dismiss="modal" aria-label="Close">Confirm</button>
    ...
    <div class="modal fade" id="deselect-artist-1st" tabindex="-1" role="dialog" aria-labelledby="loseArtist" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <!-- Modal Title -->
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Cancel this Artist First</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            ...
            <!-- Modal Body -->
                <div class="modal-body">
                    <div class="form-group">
                        <p><span class="text-gs font-weight-bold">OOPS!</span>  Looks like this artist is currently selected to play this gig.  You must cancel this artist first before selecting them to fill a different talent.</p>
...
<!-- Modal to confirm the gig request -->
<div class="modal fade" id="confGigReq" tabindex="-1" role="dialog" aria-labelledby="confGigReq" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <!-- Error Message Display -->
               <div class="container p-3 text-center mb-0 d-none" id="error-message-photo">
            ...
            <!-- Modal Title -->
                <div class="modal-header">
                    <h5 class="modal-title text-gs font-weight-bold" id="exampleModalLongTitle">Confirm Gig Request</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            ...
            <!-- Modal Footer -->
               <div class="modal-footer">
                    <div class="container">
                        <div class="row mb-2" style="font-size:.8em; font-weight:bold">By clicking confirm, you are agreeing that you have read and accept the terms and details of this gig.</div>
                        <div class="row text-center">
                            <div class="col col-md-12 mx-auto">
                                <button type="button" class="btn btn-gs artistAction d-inline" id="confirmGigRequest" data-dismiss="modal" aria-label="Close">Confirm</button>
                                <button type="button" class="btn btn-danger d-inline" data-dismiss="modal" aria-label="Close">Cancel</button>
                            </div>
                        </div>
                    </div>
...
<!-- Modal to confirm the cancel artist -->
<div class="modal fade" id="conf_canc_artist_req" tabindex="-1" role="dialog" aria-labelledby="conf_canc_artist_req" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <!-- Error Message Display -->
                <div class="container p-3 text-center mb-0 d-none" id="error-message-photo">
            ...
            <!-- Modal Title -->
                <div class="modal-header">
                    <h5 class="modal-title text-gs font-weight-bold" id="exampleModalLongTitle">Confirm Cancellation</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            ...
            <!-- Modal Body -->
                <div class="modal-body py-0" style="background-color: rgb(233,234,237);">
                    <div class="container text-center my-0">
                        <div class="row">
                            <div class="col" style="font-size:14px;" id="canc-conf-mess">
                            <p>Upon clicking confirm, this artist will be notified that they are no longer requested to play this gig.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Modal Footer -->
                <div class="modal-footer">
                    <div class="container">
                        <!--<div class="row mb-2" style="font-size:.8em; font-weight:bold"></div>-->
                        <div class="row text-center">
                            <div class="col col-md-12 mx-auto" id="art_req_canc_buttons">
                                <button type="button" class="btn btn-sm btn-gs d-inline" id="cancelArtistRequest"  aria-label="Close">Confirm</button>
                                <button type="button" class="btn btn-sm btn-danger d-inline" data-dismiss="modal" aria-label="Close">Cancel</button>
                            </div>
                        </div>
                    </div>
...
<!-- Modal to decline the gig request -->
<div class="modal fade" id="dec_gigReq" tabindex="-1" role="dialog" aria-labelledby="dec_gigReq" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <!-- Error Message Display -->
                <div class="container p-3 text-center mb-0 d-none" id="error-message-photo">
            ...
            <!-- Modal Title -->
                <div class="modal-header">
                    <h5 class="modal-title text-gs font-weight-bold" id="exampleModalLongTitle">Decline This Gig Request</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            ...
            <!-- Modal Body -->
                <div class="modal-body py-0" style="background-color: rgb(233,234,237);">
                    <div class="container text-center my-0">
                        <div class="row">
                            <div class="col" style="font-size:14px;">
                            <label class="text-gs mb-1 mt-2" style="font-size:12px;font-weight:bold;">Reason for declining gig request (optional)</label>
						    <textarea class="form-control mb-2" name="reasonForGigDecline" placeholder="If you're up to it, please share..." wrap="" rows="5" aria-label="With textarea"><?php echo $getGigDetails['message'];?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Modal Footer -->
                <div class="modal-footer">
                    <div class="container">
                        <div class="row text-center">
                            <div class="col col-md-12 mx-auto">
                                <button type="button" class="btn btn-danger artistAction d-inline" id="declineGigRequest" data-dismiss="modal" aria-label="Close">Decline</button>
                                <button type="button" class="btn btn-gs d-inline" data-dismiss="modal" aria-label="Close">Cancel</button>
                            </div>
                        </div>
                    </div>
...
<!-- artist action successful -->
<div class="modal fade" id="art_action_succ" tabindex="-1" role="dialog" aria-labelledby="art_action_succ" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <!-- Error Message Display -->
                <div class="container p-3 text-center mb-0 d-none" id="error-message-photo">
            ...
            <!-- Modal Title -->
                <div class="modal-header">
                    <h5 class="modal-title text-success font-weight-bold" id="exampleModalLongTitle">Action Submitted successfully</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            ...
            <!-- Modal Footer -->
                <div class="modal-footer">
                    <div class="container">
                        <div class="row text-center">
                            <div class="col col-md-12 mx-auto">
                                <button type="button" class="btn btn-danger d-inline" data-dismiss="modal" aria-label="Close">close</button>
                            </div>
                        </div>
                    </div>
