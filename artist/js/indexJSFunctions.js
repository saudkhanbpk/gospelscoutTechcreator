...
new_owl_div += '<div class="col-lg-4 col-md-4 col-12 mb-4" onclick="window.location.href=\'https://www.stage.gospelscout.com/views/artistprofile.php?artist='+value[y][0].iLoginID+'\'" style="cursor: pointer;">';
...
// Check if the search type is 'SBT'
    ...
    /* Slides */
      ...
      for(x in vidArray){
        ...
        if( vidArray[x].youtubeLink != ''){
          ...
          new_owl_div += '<video id="example_video_1"  class="video-js vjs-default-skin embed-responsive-item" controls  ><source src="https://www.stage.gospelscout.com'+vidArray[x].videoPath+'" type="video/mp4"><p class="vjs-no-js">To view this video please enable JavaScript, and consider upgrading to a web browser that <a href="" target="_blank">supports HTML5 video</a></p></video>';
        }  
        new_owl_div += '</div></div>';
      }
...
/* Function to call artists to the page */
  function getartistFunct(selectedTalent,artistType,page_no){
    ...
    // var url = 'https://www.stage.gospelscout.com/artist/phpBackend/connectToDb.php?talent='+selectedTalent+'&type='+artistType+'&page_no='+page_no; 
    var url = 'https://www.stage.gospelscout.com/artist/phpBackend/connectToDb_new.php?talent='+selectedTalent+'&type='+artistType+'&page_no='+page_no; 
