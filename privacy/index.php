...
<div class="container mb-3" style="margin-top:100px;>
	<div class="row">
		...
		<div class="col-md-12 col-sm-12 col-lg-12" id="privPageDiv" style="text-align: left; font-size:14px">
			<p>GospelScout operates <a href="https://www.stage.gospelscout.com" target="_blank">https://www.stage.gospelscout.com</a> . This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.</p>
