...
?>
  ...
  <header class="masthead" style="padding-top:50px;">
      ...
      <div class="row bg-pirimary h-100">
        <div class="col-lg-7 my-auto">
          <div class="header-content mx-auto">
            ...
            <a id="btn_findArtists2" href="https://www.stage.gospelscout.com/artist/" class="btn btn-lg btn-gs btn-block text-uppercase" type="button">Find Artists</a> 
          </div>
        </div>
      </div>
    </div>-->
    ...
    <!--<div class="d-none d-xl-block" style="position:absolute;top:300px;right:150px">
      <img src="https://www.stage.gospelscout.com/img/banner_img_4.png" class="img-fluid" alt="" style="height:auto; width:1000px;" >
    </div>-->
    <!-- New test carousel -->
              ...
              <div class="carousel-inner h-100 text-center">
                <div class="carousel-item h-100 active pl-3 " id="slide1Landing" style="min-height:400px">
                   <h2 class="mb-3 mt-4 carousel-text">Need reliable musicians for your church services, studio sessions, events, etc.?</h2>
                    <a id="btn_findArtists2" href="https://www.stage.gospelscout.com/artist/" class="btn btn-lg btn-block btn-gs text-uppercase carousel-btn"  type="button">Find Artists</a> <!--style="background-color:#9549AD"-->
                </div>
                <div class="carousel-item h-100"  id="slide2Landing" style="min-height:400px">
                  ...
                  <a id="btn_findGig" href="https://www.stage.gospelscout.com/findgigs" class="btn btn-lg btn-gs btn-block text-uppercase carousel-btn" type="button">Find Gigs</a> 
                ...
                <div class="carousel-item h-100" id="slide3Landing" style="min-height:400px;">
                  ...
                  <a id="btn_findArtists3" href="https://www.stage.gospelscout.com/publicgigads/" class="btn btn-lg btn-gs btn-block text-uppercase carousel-btn" type="button">Post a Gig Ad</a> 
                </div>
                    ...
                    <div class="col-lg-12 col-xl-12 mx-auto p-0">
                      ...
                      <div class="card card-signin flex-row my-5">
                        ...
                        <div class="card-body">
                          ...
                          <form name="frmLogin2" id="frmLogin2" method="post" class="form-signin" action="https://www.stage.gospelscout.com/signup/artist/">
  ...
  <section class="features" id="features" style="background-color: rgb(255,255,255);">
        ...
        <div class="col-12 my-auto">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-6">
                <div class="feature-item">
                  ...
                  <div class="my-0 mx-0 p-0" style="min-height:100px; width:auto; background: no-repeat center url('https://www.stage.gospelscout.com/img/find_gigs2.svg'); background-size: 85px 85px;"></div>
                  <h3>Find A Gig</h3>
                  <!--<p class="text-muted">Create an Artist profile today!  You will gain direct access and have the ability to perform filtered searches through stage.gospelscout's gig listings. In addition, you will automatically receive notifications for newly-posted gigs that match your profile.</p>-->
                  <ul class="text-left">
                    <li><p class="text-muted">Gain direct access to stage.gospelscout's gig listings.</p></li>
              ...
              <div class="col-lg-6">
                <div class="feature-item">
                  ...
                  <div class="my-0 mx-0 p-0" style="min-height:100px; width:auto; background: no-repeat center url('https://www.stage.gospelscout.com/img/find_artist2.svg'); background-size: 85px 85px;"></div>
                  <h3>Find & Book Artists</h3>
                  <!--<p class="text-muted">You can easily find and book artists by performing either a filtered search directly through our artist listings or by creating a user profile and posting a gig ad.  When posting a gig ad, stage.gospelscout does most of the work for you. Simply enter in your requirements and stage.gospelscout will search our database of qualified artists and direct them to your post. </p>-->
                  <ul class="text-left">
            ...
            <!--<div class="row">
              <div class="col-lg-6">
                <div class="feature-item">
                  <div class="my-0 mx-0 p-0" style="min-height:100px; width:auto; background: no-repeat center url('https://www.stage.gospelscout.com/img/grow_church.svg'); background-size: 85px 85px;"></div>
              ...
              <div class="col-lg-6">
                <div class="feature-item">-->
                  ...
                  <!--<div class="my-0 mx-0 p-0" style="min-height:100px; width:auto; background: no-repeat center url('https://www.stage.gospelscout.com/img/find_church.svg'); background-size: 85px 85px;"></div>
                  <h3>Find a Church</h3>-->
    ...
    <!--<div class="d-none d-xl-block" style="position:absolute;top:350px;left:250px;">
      <img src="https://www.stage.gospelscout.com/img/banner_img_5.png" class="img-fluid" alt="" style="height:700px;width:auto;"> 
    </div>-->
  </section>
          ...
          <div class="container marketing pt-0" id="signupSect">
            ...
            <div class="row">
              <div class="col-lg-4"> <!-- rounded-circle -->
                <img class="rounded-circle" style="margin:35px 0 35px 0" src="https://www.stage.gospelscout.com/img/music5.gif" alt="Generic placeholder image" width="200" height="74">
                <p class="font-weight-bold" style="font-size:1.8em;">Artists</p>
                <!--<p>Whether you are an artist looking to develop your skills, get more exposure to your local community, or collaborate with other talented artists, stage.gospelscout is the place for you.  Create a profile today.</p>-->
                <ol class="text-left" >
              ...
              <div class="col-lg-4">
                <img class="rounded" src="https://www.stage.gospelscout.com/img/church.svg" alt="Generic placeholder image" width="128" height="128">
              ...
              <div class="col-lg-4">
                <img class="rounded" src="https://www.stage.gospelscout.com/img/dummy.svg" alt="Generic placeholder image" width="128" height="128">
                ...
                <a href="https://www.stage.gospelscout.com/signup/gen_user/" class=" btn btn-sm p-3 text-white font-weight-bold align-middle mb-2 mb-md-0 mt-2 mt-md-0" style="border:none;border-radius:10px;background-image:linear-gradient(0deg,#9549AD,#B876CC)">Create a Profile &raquo;</a>
              </div><!-- /.col-lg-4 -->
            </div><!-- /.row -->
          </div><!-- /.container -->
    ...
    <div class="container my-0 py-0 bg-danger">
      <div class="row my-0 py-0 bg-primary">
        ...
        <div class="col-12 col-md-8 text-center mx-auto bg-white py-4 px-3 px-md-5" style="background-color:rgba(185,125,212,.2);"><!--  style="background-color:rgba(248,173,121,.5);"> -->
          <img class="rounded" src="https://www.stage.gospelscout.com/img/kirk_cover.jpg" alt="Generic placeholder image" width="200" height="225" style="object-fit:cover; object-position:0,0;"><!-- box-shadow: -3px 4px 10px 0px rgba(0,0,0,1); -->
      ...
      <div class="row my-0 py-0 bg-white">
        <div class="col-12 col-lg-6 text-center bg-white py-4 px-3 px-md-5 d-none d-lg-block position-relative">
          <div class="position-absolute" style="top:-120px">
            <img src="https://www.stage.gospelscout.com/img/help_desk.svg" alt="Generic placeholder image" width="100%" height="500" style="object-fit:cover; object-position:0,0;">
        </div>
        </div>
  ...
  <script>
      ...
      var useremailid = document.getElementById("inputEmail2").value;
      $.ajax({
            url:"user_check.php",    //the page containing php script
            type: "post",    //request type,
            dataType: 'json',
            data: {useremailid: useremailid},
            success:function(res){
                // console.log(data);
                if(res.user_status_found == 1)
                {
                    $("#btn_login2").prop('disabled', true);
                   /*  var div = document.getElementById("loadlogin2");
                    div.innerHTML += " User Is Already Register !"; */
                    $('#loadlogin2').append("User Is Already Register ! <a data-toggle='modal' data-target='#login-signup' href='#'>Please click here for Login</a>");

                }else{
                     $("#btn_login2").removeAttr('disabled');
                     $("#loadlogin2").remove();
                }
            }
        });
