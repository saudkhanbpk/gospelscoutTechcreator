$(document).ready(function(){
		            ...
		            if(vidMethod != '') {
			            ...
			            /* Instiate new form xhr */
				            ...
				            /* Calculate and display the file upload progress */
			              	...
			              	// new_vid_xhr.open('post', 'https://www.gospelscout.com/views/xmlhttprequest/connectToDb_artistprofile.php')
					            ...
					            /* Instiate new form xhr */
									...
									if(parsedResponse.response){
										...
										/* Re-direct to the view all photo page */
											window.location = 'https://www.gospelscout.com/views/viewAllPhoto.php?albumID='+album_id+'&artistID='+artist_id;
									}
									else{
					              	...
					              	new_photo_xhr.open('post', 'https://www.gospelscout.com/views/fileUpload.php')
	 ...
	 ********************************/
		...
		/* Update the Subsribee Seetings */
	        $('#contentContainer').on('click', '#subscribeeButton', function(event){
	        	...
	        	subscribeeSettingsDisplay.open('GET','https://www.gospelscout.com/views/subscribeSettingsUpdate.php?table=subscribeesetting&iRollID='+iRollID+'&vidNotification='+vid+'&picNotification='+pic+'&eventNotification='+events+'&gigNotification='+gigs); 
	    ...
	    /* Update the SubsriberSettings */
    	 // $('#subscriberButton').click(function(event){
	    	$('#contentContainer').on('click', '#subscriberButton', function(event){
	        	...
	        	subscriberSettingsDisplay.open('GET','https://www.gospelscout.com/views/subscribeSettingsUpdate.php?table=subscribersetting&iLoginID='+iLoginID+'&vidNotification='+vid+'&picNotification='+pic+'&eventNotification='+events+'&gigNotification='+gigs); 
	    ...
	    /* Add/Remove Subscription via the subscribee's page */
            $('#contentContainer').on('click', '.checkexist',function(event){
                ...
                del.open('GET', 'https://www.gospelscout.com/views/subscribeSettingsUpdate.php'+param9+param10+param11);
                del.send();
            });
	 ...
	 ********************************/
		...
		ueqXhr.open('get',`https://www.gospelscout.com/calendar/phpBackend/myFeed.php?u_Id=${u_id}&formatTime=true`);
		ueqXhr.send();
	 /********************************
	...
	********************************/
		$('#viewCal').on('click', (e) => {
			...
			if(userStatus === 'siteGuest'){
				...
				window.location = `https://www.gospelscout.com/calendar/?u_Id=${userId}`;
			}
		});
	/********************************
