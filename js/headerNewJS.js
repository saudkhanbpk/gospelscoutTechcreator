		...
		$(function () {
			...
			if(checkLogin.status == 200){
				...
				location.reload(); 
                	...
                	window.location = `https://www.stage.gospelscout.com/calendar/?u_Id=${cal_u_Id}`;
              	}
					...
					window.location = "https://www.stage.gospelscout.com/views/artistprofile.php";  
				}else if(data == 'church'){
					window.location = "https://www.stage.gospelscout.com/views/churchprofile.php";  
				}else if(data == 'user'){
				window.location = "https://www.stage.gospelscout.com/artist";
			...
			checkLogin.open('POST', 'https://www.stage.gospelscout.com/views/checklogin.php');
...
/* User Signup Prelim Form */
  $('input[name=profType]').on('click',function(e){
    ...
    if(prof_type == 'artist'){
      $('form[name=frmLogin2]').attr('action','https://www.stage.gospelscout.com/signup/artist/');
    }else{
      $('form[name=frmLogin2]').attr('action','https://www.stage.gospelscout.com/signup/gen_user/');
    }
...
/* Log Out */
  function logOut(){
    ...
    logout.open("GET", "https://www.stage.gospelscout.com/views/logout.php");
    logout.send(); 
  }
...
/* Check for user's connect account Id - fetch dashboard URL */
	$('#goTo_str_dashboard').click(function(event){
		...
		var getDash_xhr = new XMLHttpRequest();
	 	...
	 	getDash_xhr.open('post','https://www.stage.gospelscout.com/include/get_str_dash.php');
...
/* Recovery page var */
	var recoveryPage = "https://www.stage.gospelscout.com/views/pwordRecovery.php";
	...
	/* Query the loginmaster for the loginID corresponding to the user's email */
		...
		$(".accept").click(function(){
			$(".cookie").hide();
			  ...
			  //update session
				...
				acceptCookieXHR.open('get', 'https://www.stage.gospelscout.com/views/checklogin.php?acceptCookie=true');
		...
		// check if visitor accepted cookie policy
			...
			cookieXHR.open('get', 'https://www.stage.gospelscout.com/views/checklogin.php?cookieCheck=true');
			cookieXHR.send(); 