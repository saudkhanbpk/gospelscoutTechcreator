				        ...
				        /* Display artists and churched that you are currently subscribed to */
				            buildSubscribeDisplay += '<div class="container"><div class="row" style="font-size: 13px">';
			                    for(x_subscriptions in obj.subscriptions){
			                        ...
			                        buildSubscribeDisplay += '<label class="custom-control-label" for="userID_'+obj.subscriptions[x_subscriptions].iRollID+'"><a href="https://www.gospelscout.com/views/';
...
/* Call function to display data based on tab selection */
	function getTabData(tab,u_type,u_id){
		...
		/* Get Artist Content  XHR */
			...
			artist_content_xhr.open('get','https://www.gospelscout.com/views/xmlhttprequest/connectToDb_artistprofile.php?content_type='+tab+'&u_type='+u_type+'&3&u_id='+u_id);
