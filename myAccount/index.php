...
?>
		<!-- Custom styles for headers on page with white background -->
  		<link href="<?php echo URL;?>home/css/header-adjustment.css" rel="stylesheet">
			...
			<div class="container bg-white mt-5 p-4 pt-5" style="max-width: 900px;min-height:400px">
				...
				<!-- For Artists Only - Talent and bio Section -->
					...
					?>
				<!-- /For Artists Only - Talent and bio Section -->
				<!-- List and Update user payment info -->
					<div class="container mt-3">
						<h5 class="text-gs">Payment Info</h5>
						<div class="row pl-2">
							<div class="col-12 col-md-7">
								<label class="text-gs" style="font-size:12px;font-weight:bold" for="musicExperience">Default Payment Method</label>
								<div class="container">
									<div class="row">
										<div class="col" id="displayCurrentPaymentMethods">
							...
							<div class="col-12 col-md-7" style="border-top:.5px solid rgba(0,0,0,.3">
								<label class="text-gs" style="font-size:12px;font-weight:bold" for="musicExperience">Additional Payment Methods</label>
								<div class="container">
									<div class="row">
										<div class="col" id="displayAddtlPaymentMethods" style="font-size:.8em">
										<!-- Display methods here -->
										<div class="container text-center"><div class="row"><div class="col"><div class="container text-center"><div class="spinner-border text-center text-gs font-weight-bold" style="width:3em;height:3em;" id="payment-spinner" aria-hidden="true" role="status"><span class="sr-only">Loading...</span></div><p style="font-size:1.3em;" class="text-gs ml-0 font-weight-bold typedElement">Just One Sec...</p></div></div></div></div>
										</div>
									</div>
							...
							<div class='col-12 col-md-7'>
								<!-- <button type="button" class="btn btn-gs btn-sm mt-2" id="deactMyAcct">Deactivate My Account</button>  -->
							</div>
						</div>
					</div>
				<!-- /List and Update user payment info -->
...
<?php 
	/* Include the Modals page */
        ...
        include(realpath($_SERVER['DOCUMENT_ROOT']) . '/myAccount/phpBackend/myAccountModal.php');
        // echo 'Testing this in php';
...
<script src="<?php echo URL;?>myAccount/js/myAccountFunctionsJS.js?16"></script> 
<script src="<?php echo URL;?>myAccount/js/myAccountJS.js?23"></script> 
