...
******************************************************/
    ...
    const response = await fetch("https://www.stage.gospelscout.com/views/xmlhttprequest/get_set_str_tok_new.php?setup_intent=true");
...
function fetchDisplayCurrMethod(){
  ...
  /* Send customer check xhr */
    ...
    cust_check_xhr.open('post',"https://www.stage.gospelscout.com/views/xmlhttprequest/get_set_str_tok_new.php");
...
function fetchDisplaymethods(){
    /* Call to the DB for payment methods */
        ...
        get_methods_xhr.open('post',"https://www.stage.gospelscout.com/views/xmlhttprequest/get_set_str_tok_new.php");
...
******************************************************/
    function removePayMethod(pm){
        ...
        remove_pm_xhr.open('post',"https://www.stage.gospelscout.com/views/xmlhttprequest/get_set_str_tok_new.php");
