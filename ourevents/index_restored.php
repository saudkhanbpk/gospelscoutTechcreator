    ...
    <!-- style the stripe form -->
      ...
      <header class="masthead popUpWorshipMast">
	    <div class="container h-100">
	      <div class="row h-100">
	        <div class="col-lg-7 my-auto">
	          <div class="header-content mx-auto">
		          <h1 class="text-left"><span class="text-gs">#</span>PopUpWorship<span class="text-gs">LA</span> IS HERE</h1>
		          <p>Immerse yourself in an engaging spiritual environment surrounded by amazing talent and fellow worshipers</p>
	          </div>
	        </div>
	        <div class="d-none d-md-block col-lg-5 my-auto"></div>
	      </div>
	    </div>
	    <!--
 ...
 <!-- <div class="spinner-border text-gs" id="payment-spinner" role="status">
    ...
    <script src="<?php echo URL;?>popupworship/js/indexJS.js?48"></script>
  </body>
</html>
