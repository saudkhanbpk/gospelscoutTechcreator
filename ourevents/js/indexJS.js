					...
					/* A valid user is logged in */
						// identify if user has the required portfolio links or content accessible for review and selection
							// Create XHR to query artistvideomaster and moremusicmaster for entries associated with current user's id
								...
								xhr.open('get', 'https://www.stage.gospelscout.com/ourevents/phpBackend/connectToDb.php?user_id='+user_id+'&reqCheck=true');
								xhr.send()
 ...
 ******************************************/
 	$(document).ready(function(){
 		...
 		/* check puweventsmaster table for any future popUpWorship events */
			...
			xhr.open('get', 'https://www.stage.gospelscout.com/ourevents/phpBackend/connectToDb.php?puwEvents=true');
			xhr.send()
				...
				// Handle form when submission is valid 
					submitHandler: function(form){
						...
						//submit form via ajax once form and zip code is validated 
							...
							xhr.open('post','https://www.stage.gospelscout.com/ourevents/phpBackend/connectToDb.php');
							xhr.send(nfo);		
					},
 ...
 *************************/
	...
	var dropzone = new Dropzone(
		'#demo-upload', 
		{	
			url: 'https://www.stage.gospelscout.com/ourevents/phpBackend/connectToDb.php',
			paramName: 'hostImgs',
			uploadMultiple: true,
			// chunking: true,
					...
					// Variables 
						...
						.then(cityFound => {
								...
								if(cityFound.state == userState){
									...
									vol_xhr.open('post','https://www.stage.gospelscout.com/ourevents/phpBackend/connectToDb.php');
						...
						stripe.createToken(card).then(function(result) {
							...
							displayLoadingPage(action);
				                ...
				                /* Create a charge here */
				                    ...
				                    newCharge.open('post', 'https://www.stage.gospelscout.com/ourevents/phpBackend/connectToDb.php');
