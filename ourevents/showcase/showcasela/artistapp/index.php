            ...
            <div class="col-12 col-lg-10 col-xl-8 mx-auto p-0 my-0 mb-0" style="box-shadow: 0px 10px 10px 8px #888888;">
                ...
                <div class="container bg-white mb-0 pt-4 pb-0">
                    <div class="row mb-0 pb-0">
                        <div class="col text-center mb-0 pb-0"><img class="mx-auto" src="https://www.stage.gospelscout.com/img/logoJpg.jpg" alt="" width="80" height="90" style="object-fit:cover; object-position:0,0;"></div>
                    </div>
