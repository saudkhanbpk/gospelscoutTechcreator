			...
			<div class="bg">
				<div class="container">
					<div class="col-lg-3 col-md-3 col-sm-3 p0">
						<div class="profile"> <img style="height:250px;border: 2px solid rgb(142,68,173);" src="<?php if($userRow['sProfileName'] != ""){echo URL;?>upload/church/<?php echo $userRow['sProfileName'];}else{?>img/profile.jpg<?php }?>" class="img-responsive center-block"> </div>
					</div>
					<ul class="nav nav-tabs" role="tablist">
						...
						<li class="nav-item collaps"> <a class="nav-link" href="#references" role="tab" data-toggle="tab">About</a> </li>
						<li class="nav-item collaps"> <a class="nav-link" href="#pdf" role="tab" data-toggle="tab">Give</a> </li>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 p0">
						...
						//$vdiList = array_reverse($vdiList);
																...
																?>
																<div class="row <?php if($gistmaster[$gi]['sVideo'] != ""){?>borderbuttom<?php } ?>">
		...
		//Youtube star rating............................
								$(function() {
									...
									$.getJSON("https://www.googleapis.com/youtube/v3/videos", {
										...
										$("#uname").text(uname.substr(0,12));
										$("#Uviews").text(data.items[0].statistics.viewCount+" Views");
...
<div role="tabpanel" class="tab-pane fade" id="buzz">
	<div class="col-lg-12 col-md-12 col-sm-12 white mg0">
		...
		#light<?php echo $popimg;?> {
							...
							<a href="#" onclick="lightbox_open(<?php echo $popimg;?>);"><img src="<?php echo URL;?>upload/gallery/<?php echo $albummaster[$a]['sAlbumName'];?>/<?php echo $gallerymaster[$ga]['sGalleryImages'];?>" class="img-responsive center-block artistphotos"> </a> </div>
							<?php 
							$popimg ++;
						}
		...
		<div class="col-lg-12 col-md-12 col-sm-12 white chang mg0">
			<div class="col-lg-12 col-md-12 col-sm-12 borderbuttom text">
							...
							if(count($amenitimaster) > 0){
								...
								for($c=0;$c<count($amenitimaster);$c++){
									if(in_array($amenitimaster[$c]['iAmityID'],$sAmenitis)){
										...
										?>
										<li style="list-style:none;"><strong style="margin-left: -40px;"><?php echo $noA.'.'.ucwords(trim($amenitimaster[$c]['sAmityName']));?></strong></li>
										<?php
										$noA ++;
									}
						...
						//echo ucwords(trim($str,','));
							...
							if($userRow['sOtherAmenitis'] != ''){
								...
								foreach($sOtherAmenitis as $mic){
									?>
									<li style="list-style:none;"><strong><?php echo $noA.'.'.ucwords(trim($mic));?></strong></li>
									<?php 
									$noA ++;
								} }?>
							</li>
							...
							<li>
								...
								if(count($churchministrie) > 0){
									...
									for($c=0;$c<count($churchministrie);$c++){
										...
										?>
										<li style="list-style:none;margin-left: -40px;"><strong style="margin-left: -40px;"><?php echo $n.'.'.ucwords(str_replace("_"," ",$churchministrie[$c]['sMinistrieName']));?></strong></li>
										<?php
										$n ++;
									}
						//echo ucwords(trim($str,','));
				...
				<div class="col-lg-12 col-md-12 col-sm-12 borderbuttom text">
					...
					<h2>
						<ul class="year">
							<li><strong style="margin-left: -40px;">
								<?php
								if($userRow['sDenomination'] != ''){
				...
				<div class="col-lg-12 col-md-12 col-sm-12 borderbuttom text">
					...
					<h2>
						<ul class="year">
							<li><strong style="margin-left: -40px;">
								<?php if($userRow['sMission'] != ''){echo ucwords($userRow['sMission']);}else{echo '---';}?>
							</strong> </li>
						</ul>
					</h2>
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 borderbuttom text">
					<p>When church was founded:</p>
					<h2>
						<ul class="year">
							<li> <strong style="margin-left: -40px;">
			...
			if($obj->insert($field,$value,"churchbooking")){
				...
				if ( $iAmountID > 0 ) {
					...
					<form action='<?php echo $paypal_url; ?>' method='post' id="frmPayPal1" name='frmPayPal1'>
						...
						<input type='hidden' name='cancel_return' value='<?php echo URL."churchprofile?type=cancel"; ?>'>
						<input type='hidden' name='return' value='<?php echo URL."churchprofile"; ?>'>
					</form>
					<?php
																					...
																					for($sub=0;$sub<count($subscriblist);$sub++){
																						...
																						<div class="col-lg-6 col-md-6 ocl-sm-6">
																							...
																							if ( $subscriblist[$sub]['sType'] == 'church') {
																								$pageurl = "churchprofile.php?church=";
																							} else {
																								$pageurl = "artistprofile.php?artist=";
																							}
																							?>
