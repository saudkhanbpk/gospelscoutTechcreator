...
window.onload = function () {
			...
			$(function () {     
				...
				$('#sTimeOfEventUpdate<?php echo $stNo;?>').datetimepicker({
					format: 'LT'
                                ...
                                <a class="remove_field"><span class="serviceRemove01">X</span></a>
   ...
   <input type="hidden" value="<?php echo count($churchtimeing);?>" name="totalServises" id="totalServises" />
    ...
    <fieldset>
            ...
            <div class='row' id="new<?php echo $n;?>">
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        ...
                        <a class="remove_field" onclick="soloremove01(this)" id="<?php echo $n;?>"><i class="fa fa-fw fa-remove"></i></a> </div>
                </div>
            </div>
        ...
        <div class="form-group">
            <label for="role" class="col-lg-3 control-label"></label>
            <div class="col-lg-4"> <a class="add_field_button">Add More Amenities</a> </div>
        </div>
        ...
        <div class='row'>
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <select class="form-control" id="sMinistrieName<?php echo $ch;?>" name="sMinistrieName[]" aria-invalid="false">
                ...
                <div class="col-lg-4">
                    <a id="<?php echo $ch;?>" onclick="soloremove1(this)" class="Solo-Remove remove">Remove</a>
                </div>
            </div>
        </div>
        <div class='row'>
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="file" class="form-control file uploadsvideoimage" accept="image/*" id="sVideoImage" multiple='multiple' name="sVideoImage<?php echo $ch;?>[]" >
                </div>
            </div>
        </div>
        <div class='row'>
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="file" class="form-control file uploadsvideo" id="sImage" multiple='multiple' name="sImage<?php echo $ch;?>[]" >
                </div>
            </div>
        </div>
        <div class='row'>
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    <input type="text" placeholder="Enter YouTube Link" class="form-control" value="" id="youtube" name="youtube" >
                </div>
                <div class="col-lg-4">
        ...
        <div class='row'>
            <div class="form-group">
                <label for="ye" class="col-lg-3 control-label"></label>     
                <?php if($ch == (count($churchministrie) - 1)){?>
                    <a id="AddSolo" class="addmore">Add More Ministries</a>
                <?php } ?>  
        </div>
        </div>
        <?php 
	  $cnt ++ ;
        ...
        <div class='row'>
            <div class="form-group">
                <label for="mi" class="col-lg-3 control-label">Church Ministries</label>
                <div class="col-lg-4">
                    <select class="form-control" id="sMinistrieName" name="sMinistrieName[]" aria-invalid="false">
                    	<!--<option value="">Select ministry</option>-->
        ...
        <div class='row'>
            <div class="form-group">
                <label for="ye" class="col-lg-3 control-label">Upload Ministry Video Image</label>
                <div class="col-lg-4">
                    <input type="file" accept="image/*" class="form-control file uploadsvideoimage" id="sVideoImage" multiple="" name="sVideoImage0[]" >
                </div>
            </div>
        </div>
        <div class='row'>
            <div class="form-group">
                <label for="ye" class="col-lg-3 control-label">Upload Ministry Video</label>
                <div class="col-lg-4">
                    <input type="file" class="form-control file uploadsvideo" id="sImage" multiple="" name="sImage0[]" >
                </div>
            </div>
        </div>
        <div class='row'>
            <div class="form-group">
                ...
                <div class="col-lg-4"> <a id="AddSolo" class="addmore">Add More Ministries</a> </div>
            </div>
        </div>
        <?php 	
			}
...
data +=           '<option value="Childrens_Ministry">Children\'s Ministry</option>';
data +=           '<option value="Dance_ministry">Dance Ministry</option>';
data +=           '<option value="Drama_ministry">Drama Ministry</option>';
data +=           '<option value="Media_ministry">Media Ministry</option>';
data +=           '<option value="Mime_ministry">Mime Ministry</option>';
data +=           '<option value="Music_ministry" >Music Ministry</option>';
data +=           '<option value="Preaching_Teachings">Preaching/Teachings</option>';
data +=           '<option  value="Sound_ministry">Sound Ministry</option>';
data +=           '<option  value="Youth_ministry">Youth Ministry</option>';
data +=           '<option  value="Others">Others</option>';
data +=           '              </select>';
data +=           '            </div>';
data +=           '        </div></div>';
data +=           '  <div class="row">';
...
$(".adddiv").each(function() {
	...
	document.getElementById('churnumber').value = dynamicid ;
