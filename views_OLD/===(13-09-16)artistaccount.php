<?php require_once realpath($_SERVER["DOCUMENT_ROOT"]).'/gospelscout/include/header.php';?>
<script>
$(document).ready(function() {
	...
	$('#countryId').on('change', function (e) {
			  ...
			  $.ajax({
				type: 'post',
				url: '<?php echo URL;?>managearea?type=state&iCountriID='+cntID,
				//data: formData,
	...
	$('#stateId').on('change', function (e) {
			  ...
			  $.ajax({
				type: 'post',
				url: '<?php echo URL;?>managearea?type=city&iStateID='+stateId,
				//data: formData,
				success: function (data) {
	...
	<fieldset>
      ...
      <div class='row'>
        <div class='form-group'> <span id="error_email">
          ...
          <div class='col-sm-4'>
            <input class="form-control" id="sContactEmailID" name="sContactEmailID" value="<?php if(!empty($userRow)){echo $userRow['sContactEmailID'];}?>" type="text" />
      ...
      <div class='row'>
        <div class='form-group'>
          ...
          <div class='col-sm-4'>
            <input class="form-control" id="sContactNumber" name="sContactNumber" type="text" value="<?php if(!empty($userRow)){echo $userRow['sContactNumber'];}?>" />
          </div>
        </div>
      </div>
    </fieldset>    
          ...
          <div id="divsolo<?php echo $divNo;?>">
            <div class='row'>
              <div class="form-group">
                ...
                <div class="col-lg-4"> <a class="Solo-Remove remove" onclick="soloremove(this)" id="<?php echo $divNo;?>">Remove</a> </div>
              </div>
            </div>
            <script>
$(document).ready(function(){
	...
	$('#sGift<?php echo $rolemasterAll[$i]['iRollID'];?>').val('<?php echo $rolemasterAll[$i]['sGiftName'];?>');
            ...
            <div class='row'>
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  <input type="file" accept="image/*" name="giftVideoImage<?php echo $rolemasterAll[$i]['iRollID'];?>[]" multiple="" class="form-control file uploadsvideoimage"/>
                </div>
                <script>
				$(document).ready(function(){
            ...
            <div class='row'>
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  <input type="file" accept="video/*" multiple="" name="giftVid<?php echo $rolemasterAll[$i]['iRollID'];?>[]" class="form-control file uploadsvideo"/>
                </div>
            ...
            <div class='row'>
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  <input type="text" name="yt<?php echo $rolemasterAll[$i]['iRollID'];?>" class="form-control" placeholder="Enter only youtube url" />
                </div>
          ...
          <div class='row'>
           ...
           <?php if($end == count($rolemasterAll)){?>
                <div class="col-lg-4"> <a id="AddSolo" class="addmore">Add More Talent</a> </div>
                <?php } ?>
                </div>
       </div>
          <?php
            ...
            <div class='row'>
              <div class="form-group">
                <label for="role" class="col-lg-3 control-label">Upload Talent Video</label>
                <div class="col-lg-4">
                  <input type="file" accept="video/*" name="giftVideo0[]" multiple="" class="form-control file uploadsvideo"/>
                </div>
      ...
      <div id="group" <?php if($rolemaster['sGroupType'] != 'group'){?>style="display:none;"<?php } ?>>
        ...
        <div class='row'>
              <div class="form-group">
                <label for="role" class="col-lg-3 control-label">Upload Talent Video Image</label>
                <div class="col-lg-4">
                  <input type="file" accept="image/*" multiple="" name="giftVidGrpImage[]" class="form-control file uploadsvideoimage"/>
                </div>
        ...
        <div class='row'>
              <div class="form-group">
                <label for="role" class="col-lg-3 control-label">Upload Talent Video</label>
                <div class="col-lg-4">
                  <input type="file" accept="video/*" multiple="" name="giftVidGrp[]" class="form-control file uploadsvideo"/>
                </div>
	...
	$('#mygift<?php echo $new;?>').val('<?php echo $mGift[$new];?>');
            ...
            <div class='row'>
              <div class="form-group">
                <label for="role" class="col-lg-3 control-label">My Talent</label>
                <div class="col-lg-4">
                  <select class="form-control" id="mygift<?php echo $new;?>" name="mygift[]" >
                    <option value="Accordionist">Accordionist</option>
                  <option value="Actor">Actor</option>
                  <option value="Actress">Actress</option>
                  <option value="Banjo_Player">Banjo Player</option>
	...
	$('#availability').val('<?php echo $userRow['sAvailability'];?>');
      ...
      <div class='row'>
        <div class="form-group">
          ...
          <div class="col-lg-4">         
		  <input type="text" class="form-control" id="whatkindofmusic" value="<?php if(!empty($userRow)){echo $userRow['sKindPlay'];}?>" name="whatkindofmusic" >
			...
			$n = 0;
				...
				for($i=0;$i<$grpSolo02;$i++) {
					...
					if($_FILES["giftVideo".$i]['name'] != ''){
						...
						$field = array("iLoginID","sGroupType","sGiftName","sVideo","sYoutubeUrl","sVideoName","dCreatedDate");
								$value = array($objsession->get('gs_login_id'),$roll,$sGiftName[$n],$giftImage01,$youtube[$n],$sVideoName,date('Y-m-d'));		
								$obj->insert($field,$value,"rollmaster");
...
if(document.getElementById('grpSolo').value > 0){	
	...
	var data = '<div id="divsolo'+dynamicid+'" class="adddiv">';
...
data +=           '				  <option value="Accordionist">Accordionist</option>';
data +=           '                  <option value="Actor">Actor</option>';
data +=           '                  <option value="Actress">Actress</option>';
data +=           '                  <option value="Banjo_Player">Banjo Player</option>';
data +=           '                  <option value="Bassist">Bassist</option>';
data +=           '                  <option value="Bassoonist">Bassoonist</option>';
data +=           '                  <option value="Cellist">Cellist</option>';
data +=           '                  <option value="Clarinetist">Clarinetist</option>';
data +=           '                  <option value="Composer">Composer</option>';
data +=           '                  <option value="Dancers">Dancers</option>';
data +=           '                  <option value="Drummers">Drummers</option>';
data +=           '                  <option value="Flautist">Flautist</option>';
data +=           '                  <option value="Guitarist">Guitarist</option>';
data +=           '                  <option value="Harmonica_Player">Harmonica Player</option>';
data +=           '                  <option value="Harpist">Harpist</option>';
data +=           '                  <option value="Mime_Artist">Mime Artist</option>';
data +=           '                  <option value="Organist">Organist</option>';
data +=           '                  <option value="Percussionist">Percussionist</option>';
data +=           '                  <option value="Pianist_keyboardist">Pianist/keyboardist</option>';
data +=           '                  <option value="Piccolo_Player">Piccolo Player</option>';
data +=           '                  <option value="Poet_Spoken_Word">Poet/Spoken Word</option>';
data +=           '                  <option value="Rapper">Rapper</option>';
data +=           '                  <option value="Saxophonist">Saxophonist</option>';
data +=           '                  <option value="Singer_Vocalist">Singer/Vocalist</option>';
data +=           '                  <option value="Song_Writer">Song Writer</option>';
data +=           '                  <option value="Saxophonist">Saxophonist</option>';
data +=           '                  <option value="Trombonist">Trombonist</option>';
data +=           '                  <option value="Trumpeter">Trumpeter</option>';
data +=           '                  <option value="Tubist">Tubist</option>';
data +=           '                  <option value="Violinist">Violinist</option>';
data +=           '                  <option value="Violist">Violist</option>';
data +=           '              </select>			 ';
data +=           '            </div>';
data +=           '        </div></div>';
data +=           '<div class="row">';
...
data +=           '                <div class="col-lg-4">';
data +=           '                  <input type="file" accept="image/*" name="giftVideoImageAdd'+dynamicid+'[]" multiple="" class="form-control file uploadsvideoimage"/>';
data +=           '</div>';
data +=           '</div>';
data +=           '</div>';
data +=           '<div class="row">';
...
data +=           '<div class="col-lg-4">';
data +=           '<input type="file" name="giftVideo'+dynamicid+'[]" multiple="" class="form-control uploadsvideo file"/>';
data +=           '</div>';
data +=           '</div>';
data +=           '</div>';
data +=           '        <div class="row"><div class="form-group">';
...
<?php require_once realpath($_SERVER["DOCUMENT_ROOT"]).'/gospelscout/include/footer.php';?>