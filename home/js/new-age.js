(function($) {
  ...
  var navbarCollapse = function() {
    if ($("#mainNav").offset().top > 50) {
      ...
      if( screen.width >= 992){
        ...
        $('#company-logo').attr('src','https://www.stage.gospelscout.com/img/gospelscout_logo.png');
        $('#notBell').removeClass('notBell');
        $('#notBell').addClass('notBell2');
        $('#not-numb').removeClass('not-numb');
        $('#not-numb').addClass('not-numb2');
        $('#menu-icon').attr('src','https://www.stage.gospelscout.com/img/right-menu.svg');
        $('#menu-icon').attr('src','https://www.stage.gospelscout.com/img/right-menu-2.svg');
        // $('#notBell').attr('style','background-image: url("https://www.stage.gospelscout.com/img/notification2.svg");display:inline-block;height:22px; width:22px');
      }
    } else {
      ...
      // Change barbmo page title to white color and swap out logo
        ...
        $('#company-logo').attr('src','https://www.stage.gospelscout.com/img/logo_bright_2.png');
        ...
        $('#menu-icon').attr('src','https://www.stage.gospelscout.com/img/right-menu-2.svg');
        $('#menu-icon').attr('src','https://www.stage.gospelscout.com/img/right-menu.svg');
        // $('#notBell').attr('style','background-image: url("https://www.stage.gospelscout.com/img/notification.svg");display:inline-block;height:22px; width:22px')
    }
  };
  ...
  $('#contact-form-submit').click(function(e){
    ...
    var url = 'https://www.stage.gospelscout.com/home/phpBackend/connectToDb.php';
