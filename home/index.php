          ...
          <div class="container marketing pt-0" id="signupSect">
            ...
            <div class="row">
              <div class="col-lg-4"> <!-- rounded-circle -->
                <img class="rounded-circle" style="margin:35px 0 35px 0" src="https://www.stage.gospelscout.com/img/music5.gif" alt="Generic placeholder image" width="250" height="93">
              ...
              <div class="col-lg-4">
                <img class="rounded" src="https://www.stage.gospelscout.com/img/church3.png" alt="Generic placeholder image" width="160" height="160">
              ...
              <div class="col-lg-4">
                <img class="rounded" src="https://www.stage.gospelscout.com/img/event7.jpg" alt="Generic placeholder image" width="160" height="160">
