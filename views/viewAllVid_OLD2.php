	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
		    ...
		    <!-- /Exit Modal -->
		      	...
		      	<div class="modal-footer">
		        	<button type="submit" id="removeVideo" u-type="<?php echo $currentUserType;?>" class="btn btn-gs btn-sm sectionEdit" table="talentmaster" formId="talentRemove">Remove Video</button>
		      	</div>
	    </div>
	  </div>
	</div>
