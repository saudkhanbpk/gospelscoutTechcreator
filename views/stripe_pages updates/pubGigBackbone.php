...
// exit;
        ...
        if($err > 0){
            echo $errorMess; 
            echo "<script>setTimeout(function(){ window.location.href = 'https://dev.gospelscout.com/newHomePage/views/pubGigs.php';},5100);</script>";
            exit; 
        }
        else{
            /* Define Gig Id */
...
?>  
                    <script> 
                        window.location.href = 'https://dev.gospelscout.com/newHomePage/views/xmlhttprequest/pubGigBackbone.php?id=<?php echo $g_ID;?>';
                    </script>
<?php
                }
        }
		...
		/* query the postedgigsmaster table for the gig associated with the id passed in the $_GET var */
                ...
                if(ctype_alnum($g_ID)){
                    ...
                    if(count($getPostedGig) == 0){
                        echo '<script> window.location.href = "https://dev.gospelscout.com/newHomePage/views/manageGigs1.php"</script>';
                    }
                    else{
                            ...
                            /* Is user the gig manager or artist */
                                ...
                                elseif($currentUserType == 'church' || $currentUserType == 'user'){
                                    /* Redirect user to search 4 artist page */
                                        echo '<script> window.location.href = "https://dev.gospelscout.com/newHomePage/views/search4artistNew.php"</script>';
                                }
                                else{
                    ...
                    <div class="container" style="font-size: 14px;">
                        ...
                        ?>
                            <!-- Edit, hide, delete Post (show if gig date has not passed.) -->
				                <a class="btn btn-small btn-gs text-white getStatus" href="<?php echo URL;?>newHomePage/views/pubGigs.php?gigID=<?php echo $g_ID;?>" id="postGig">Edit Post</a> 
                                ...
                                <div class="col-12 col-md-6 p-3" style="border: 1px solid rgba(149,73,173,1);box-shadow: -1px 2px 10px 0px rgba(0,0,0,1);">
                                    <div class="mb-2">
                                        <a id="artistProfile" href="#" target="_blank" style="text-decoration: none; ">
                                            <img class="aProfPic" src="<?php echo URL; ?>newHomePage/upload/artist/<?php echo $userInfo['sProfileName'];?>" id="profPic" height="50px" width="50px">
                                    ...
                                    <?php
                                        if($gDate > $today) {
                                            if($user == 'artistNotSubmited'){?>
                                                <!-- artistAction -->
                                                    <button type="button" data-toggle="modal" data-target="" class="btn btn-sm btn-gs submitInquiry" id="">I Want To Play!</button><!-- artistAction -->
                                    <?php   }else{
                                    ?>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item bg-white active" style="max-height:325px;overflow:hidden;overflow:scroll">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <h6>Your first week of bidding is on us!!!</h6>
                                            <p class="pl-2" style="font-size:12px"> From the date and time you make your first bid, you will have 7 days of free bidding so go nuts!!!  After that, we'll be watching.</p>
...
<script>
        ...
        function getArtistInfo(iLoginID,gigId,pageLoad){
            /**** Use XMLHttpRequest to fetch artist info ****/
                if(iLoginID > 0 ){
                            ...
                            /**** Parse the ResponseText as an xml string ****/
                                ...
                                /* Insert proper modal text based on a currently selected artist */
                                    if(selectedArtist == 0){
                                        ...
                                        var modalText = '<a href="<?php echo URL;?>newHomePage/views/artistprofile.php?artist='+selectedArtist+'" class="font-weight-bold text-gs" target="_blank">'+selectedArtistFirst+' '+selectedArtistLast+'</a> is currently selected for this gig. By clicking confirm, you will replace him with the newly selected artist.';
                                ...
                                /* Update the artist info detail view */
                                    ...
                                    $('.profPic').attr('src','<?php echo URL;?>newHomePage/upload/artist/'+sProfileName);
                                    $('.artistProfile').attr('href','<?php echo URL;?>newHomePage/views/artistprofile.php?artist='+iLoginID);
                    ...
                    getArtistDeets.open('get','<?php echo URL;?>newHomePage/views/xmlhttprequest/inquiryBackbone.php?u_id='+iLoginID+'&g_id='+gigId);
                    getArtistDeets.send()
                }
    ...
    /****************************** Submit or Remove Inquiry ******************************/
        $('.artistAction').click(function(event){
            ...
            inquirySubmit.open('post','<?php echo URL;?>newHomePage/views/xmlhttprequest/inquiryBackbone.php');
    ...
    /****************************** Select Artist ******************************/
        $('.selectArtist').click(function(event){
            ...
            /* Create XMLHttpRequest to send artist selection to the postedgigsmaster */
                ...
                selectArtist.open('post','<?php echo URL;?>newHomePage/views/xmlhttprequest/inquiryBackbone.php');
    ...
    (function() {
        /* Show current usage function */
            function showCurrentUsage(currentUsage){
                ...
                $('#bid_num').html(newBid_numb);new_bid_num
