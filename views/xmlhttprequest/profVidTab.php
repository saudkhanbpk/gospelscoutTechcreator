<?php 
	...
	elseif($userRow['sUserType'] == 'church'){
		...
		/* Catergorize videos according to ministry */
			foreach($result as $eachVid0){
				$tal = $eachVid0['sGiftName'];
				$talSectArray[$tal][] = $eachVid0;
			}
...
<!-- ************************** Video Container Header ****************************** -->
	<!-- Dipslay add vid button for owner of profile -->
		<div class="container my-2 pl-0" id="vidHeader">
			<div class="row">
				...
				<?php 
					if(!isset($_GET['artist']) && !isset($_GET['church']) && $currentUserID > 0){
				?>
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
		    <div class="modal-content">
		      ...
		      <form action="fileUpload.php" method="POST" name="videoAdd" id="videoAddID" enctype="multipart/form-data">
		      	<input type="hidden" name="u_type" value="<?php echo $userRow['sUserType'];?>">
			      <div class="modal-body">
			      	<?php if($userRow['sUserType'] == 'artist' || $userRow['sUserType'] == 'church'){?>
...
<?php
	if(count($result) == 0){ //churchUserID
		if($currentUserID > 0 && ($currentUserID == $artistUserID || $currentUserID == $churchUserID)){
...
if($userRow['sUserType'] == 'artist' || $userRow['sUserType'] == 'church'){
	...
	<div class="">
		<div class="row">
			...
			<div class="col-6 text-right"> 
				...
				<a class="anchor-styled" href="viewAllVid.php?<?php if($userRow['sUserType'] == 'artist' || $userRow['sUserType'] == 'group'){echo 'artistID=' . $artistUserID;}elseif($userRow['sUserType'] == 'church'){echo 'churchID=' . $churchUserID;}?>&tal=<?php echo $TalentName; ?>">View All</a>
			</div>
		</div>
		<!-- Card Rows -->
		<div class="row">
			 ...
			 ?>	
						<!-- Card Content -->
							<div class="card col-7 p-4 col-md-3 p-md-2 border-light mx-auto mx-md-0">
								<a href="videoDisplay.php?vid_id=<?php echo $eachVidArray['id']; ?>&<?php if($userRow['sUserType'] == 'artist' || $userRow['sUserType'] == 'group'){echo 'artistID=' . $artistUserID;}elseif($userRow['sUserType'] == 'church'){echo 'churchID=' . $churchUserID;}?>&tal=<?php echo $TalentName; ?>">
