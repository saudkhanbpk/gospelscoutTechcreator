		...
		if($currentUserID == ''){
			...
			if($currentUserType == 'church'){
				...
				/* Get the 2nd ministry table */
					$getAllMinistries2 = $obj->fetchRowAll('churchministrymaster', 'iLoginID=' . $currentUserID);
					/*echo '<pre>';
					var_dump($getMin);
...
?>
			...
			<div class="container bg-white mt-5 p-4" style="max-width: 900px;min-height:400px">
						...
						<form name="personalInfo" class="needs-validation" table="usermaster" novalidate>
							...
							<div class="row pl-2">
								<div class="col-10 col-md-7">
									...
									<input type="file" class="form-control form-control-sm mb-2" name="sProfileName" placeholder="Profile Image" value="<?php echo $userData['sProfileName'];?>">
				...
				<!-- Deactivate user account -->
					<form name="deactAcct" method="post">
