					    		...
					    		<div class="row pt-3 justify-content-center">
					    			<div class=" col col-md-5 bg-white text-center pt-3 pb-5 signup-steps">
										...
										<div class="container">
											...
											<input type="submit" id="btn_submit" class="btn btn-sm btn-primary d-none" disabled value="Create Profile"> <!--  -->
										</div>
								        ...
								        //find the city and state
											...
											$('#sStateName > option:selected').each(function() {
												...
												if(state == userState){
													...
													j +=1; 
													//console.log('State/Zip code Mismatch: '+j);
												}											    
											});
								    });
					      	}
				...
				if($('div.active').attr('id') == 'step5'){
					...
					/********************* Send Confirmation email ********************/
						...
						if(sendEmaiChecked){
							...
							sendMail.open("POST", "<?php echo URL;?>views/emailConf.php");
			...
			*/
			...
			/* Verify confirmation code */
				$('#btn_checkCode').click(function(event){
					...
					checkConfCode.open('POST', "<?php echo URL;?>views/emailConf.php");
