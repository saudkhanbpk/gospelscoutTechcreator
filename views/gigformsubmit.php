<?php 
	...
	if($_POST){
		...
		/************************************************** Define email Variables **************************************************/
			...
			$requestorUrl = 'http://www.stage.gospelscout.com/views/artistprofile.php?artist=' . $emailParamResults['gigDetails_gigManLoginId']; 
			...
			$actionUrl = 'http://www.stage.gospelscout.com/views/gigform.php?gigID=' .  $_POST['gigId']; 
