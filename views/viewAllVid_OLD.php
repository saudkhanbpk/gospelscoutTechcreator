...
<div class="container mt-4 px-5 viewAll-vid">
	<a href="<?php echo URL . 'views/artistprofile.php?artist=' . $_GET['artistID']; ?>"class="text-gs"><h4 class="text-capitalize text-gs text-center text-lg-left"><?php if($_GET['tal'] == 'group'){echo $result[0]['sGroupName'];}else{ echo $result[0]['sFirstName'] . ' ' . $result[0]['sLastName'];} ?></h4></a>
			 ...
			 ?>	
						<!-- Card Content -->
							<div class="card col-7 p-4 col-md-2 p-md-2 border-light mx-auto mx-md-0">
								<a href="videoDisplay.php?vid_id=<?php echo $eachVidArray['id']; ?>&artistID=<?php echo $artistUserID;?>&tal=<?php if($_GET['tal'] == 'group'){echo 'group';}else{echo $eachVidArray['sGiftName'];}?>">
							  ...
							  <div class="card-body pb-0 px-2">
							    <ul class="list-unstyled card-text-size-gs mb-0 ">
							    	...
							    	<?php 
							    		if($currentUserID != '' && $currentUserID == $_GET['artistID']){
							    	?>
	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
		    ...
		    <!-- /Exit Modal -->
		      	...
		      	<div class="modal-footer">
		        	<button type="submit" id="removeVideo"class="btn btn-gs btn-sm sectionEdit" table="talentmaster" formId="talentRemove">Remove Video</button>
		      	</div>
	    </div>
	  </div>
	</div>
