...
<script>
	...
	/* XMLHttpRequest the Artist Content to the page */
		...
		displayArtist.open('GET', 'https://www.stage.gospelscout.com/views/xmlhttprequest/search4artistContent?type=artist');
		displayArtist.send(); 
	...
	/* Return artist results for selected talent from the talent dropdown menu */
			...
			var url = 'https://www.stage.gospelscout.com/views/xmlhttprequest/search4artistContent.php?talent='+selectedTalent+'&type='+artistType; 
			...
			$('#talDropCollapser').click(function(){
				...
				if(t==0){
					...
					var displayArtist1 = new XMLHttpRequest(); 
			   		...
			   		displayArtist1.open('GET', 'https://www.stage.gospelscout.com/views/xmlhttprequest/search4artistContent');
			   		displayArtist1.send(); 
	...
	/* Send artist search criteria */
		$("#searchArtist").click(function(event){
			...
			sendSearch.open("POST", "https://www.stage.gospelscout.com/views/xmlhttprequest/search4artistContent");
