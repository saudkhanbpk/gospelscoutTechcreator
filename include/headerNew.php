...
<!-- Custom fonts for this template -->
  ...
  <!-- tab icon -->
  <link rel="icon" href="https://www.stage.gospelscout.com/img/gospelscout_logo.png">
  ...
  <!-- Login -->
  <link href="https://www.stage.gospelscout.com/include/login2.css?1" rel="stylesheet">

  <!-- Boostrap Time Picker css -->
    <link href="<?php echo URL; ?>home/css/glyphicon.css?3" rel="stylesheet">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger font-weight-bold" href="<?php echo URL;?>">
        <img id="company-logo" src="https://www.stage.gospelscout.com/img/logo_bright_2.png" style="height:50px;width:50px" class="img-fluid" alt="">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link  <?php if($page == 's4a'){echo 'active';} ?>" href="https://www.stage.gospelscout.com/artist/">Artists</a><!-- js-scroll-trigger -->
          </li>
          <!--<li class="nav-item">
            <a class="nav-link <?php if($page == 's4c'){echo 'active';} ?>" href="https://www.stage.gospelscout.com/church/">Churches</a>
          </li>
           <li class="nav-item">
            <a class="nav-link <?php if($page == 's4e'){echo 'active';} ?>" href="https://www.stage.gospelscout.com/event/">Events</a>
          </li>-->
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="https://www.stage.gospelscout.com/findgigs">Find a Gig</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="https://www.stage.gospelscout.com/ourevents/">Our Events</a>
          </li>
            ...
            <?php 
              ...
              if($currentUserID > 0 ){
                ...
                elseif($currentUserType == 'gen_user'){
                  echo '<a class="nav-link" >Hi, ' . $userName . '</a>';// echo '<span class="text-white">Hi, ' . $userName . '</span>';
                }
            ...
            ?>
              <style>
                ...
                <li class="nav-item pt-0">
                  <div class="btn-group dropdown py-0 d-inline" >
                    ...
                    <script>$('#not_svg').attr('style','fill:#000');</script>
                     <a href="" class="ml-0 pt-0 text-white align-bottom menu-icon menu-icon-common" style="display:inline" id="AccountDropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><!--  mr-5 -->
                      <img class="ml-1" id="menu-icon" src="<?php echo URL;?>img/right-menu.svg" height="20px" width="20px" class="img-fluid" alt="Responsive image">
                    </a>
