<!--<section class="cookie d-none" id="cookie">
   <div class="txt">
      <p class="">
         By using gospelscout.local,<br>
         you agree to our <a href="/privacy/#cookies" target="_blank">Cookie Policy.</a>
      </p>
   </div>
   <div>
      ...
      <div class="row text-md-left">
        <div class="col col-md-6">
          <div class="container ">
            <div class="row mb-md-3">
              <div class="col">
                <img id="company-logo" src="/img/logo_bright_2.png" style="height:40px;width:40px" class="img-fluid" alt="">
            ...
            <div class="row my-md-2">
              <div class="col">
                <p class="my-0"><img id="company-logo" src="/img/phone_icon.svg" style="height:15px;width:15px" class="img-fluid" alt=""><span class="text-content">   805 283 7269</span></p>
                <p class="my-0"><img id="company-logo" src="/img/send_email2.svg" style="height:15px;width:15px" class="img-fluid" alt=""><span class="text-content">   Administrator@gospelscout.local</span></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-md-3 mt-3 mt-md-0">
          <div class="container ">
            ...
            <div class="row my-md-2">
              <div class="col">
                <a href="https://www.facebook.com/gospelscout" target="_blank" class="text-content"><img id="company-logo" src="/img/facebook_icon.svg" style="height:25px;width:25px" class="img-fluid" alt=""> <span class="ml-1">Facebook</span></a>
              </div>
            </div>
            <div class="row my-md-2">
              <div class="col">
                <a href="https://www.instagram.com/gospelscout/" target="_blank" class="text-content"><img id="company-logo" src="/img/insta_icon.svg" style="height:25px;width:25px" class="img-fluid" alt=""> <span class="ml-1">Instagram</span></a>
              </div>
            </div>
            <div class="row my-md-2">
              <div class="col">
                <a href="https://twitter.com/GospelScout" target="_blank" class="text-content"><img id="company-logo" src="/img/twitter_icon.svg" style="height:25px;width:25px" class="img-fluid" alt=""> <span class="ml-1">Twitter</span></a>
              </div>
            </div>
...
<!-- </div> -->
  ...
  <script>window.jQuery || document.write('<script src="/twbs/bootstrap/assets/js/vendor/jquery-slim.min.js"><\/script>')</script>
  <!--<script src="<?php echo URL;?>home/vendor/jquery/jquery.min.js"></script> -->
  <!--<script src="https://dev.gospelscout.local/newHomePage/composer/vendor/twbs/bootstrap/dist/js/bootstrap.min.js"></script> -->
  <!--<script src="https://dev.gospelscout.local/Composer1/vendor/twbs/bootstrap/assets/js/vendor/popper.min.js"></script>-->
