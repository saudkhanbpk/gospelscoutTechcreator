...
function reloadPage(){
	...
	if(url != ''){
		...
		if (url == 'artist') {
			...
			document.location.href = "http://www.gospelscout.com/views/artistprofile.php?artist="+id,true;
			
		} else if (url == 'church'){
			
			window.location.href = "http://www.gospelscout.com/views/churchprofile.php?church="+id;	
						
		} else{
			
			window.location.href = "http://www.gospelscout.com/views/userprofile.php?artist="+user;		
