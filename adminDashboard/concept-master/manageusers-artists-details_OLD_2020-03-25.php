                                      ...
                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <!-- <form action="" method="POST" name="photoAdd" enctype="multipart/form-data" id="confirmForm"> onclick="submitReset()"-->
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-danger" id="confRemoval" data-dismiss="modal" aria-label="Close">Confirm</button>
    ...
    <script>
        ...
        /* Deactivate users account */
            $('#confDeactivate').click(function(event){
                ...
                sendDeact.open('POST','<?php echo URL; ?>adminDashboard/concept-master/adminDeact-acct.php');
        ...
        /* Activate User's Account */
            $('#confActivate').click(function(event){
                ...
                sendAct.open('POST','<?php echo URL; ?>adminDashboard/concept-master/adminDeact-acct.php');
        ...
        /* Create the fetchGigs Function */
            function fetchGigs(selection1, selection2, userId){
               ...
               getGig.open('GET', '<?php echo URL; ?>adminDashboard/concept-master/adminGet-gig-event.php?sel1='+selection1+'&sel2='+selection2+'&u_ID='+userId);
               getGig.send();
           }
        ...
        /* Fetch Video Flags */
            $('.fetchFlags').click(function(event){
                ...
                if(numbFlags > 0){
                    ...
                    getFlags.open('GET', '<?php echo URL; ?>adminDashboard/concept-master/adminGet-vidFlags.php?u_ID='+userId+'&vid_ID='+vid_ID);
                    getFlags.send();
                }
            });
    </script>
