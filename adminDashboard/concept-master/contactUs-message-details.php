    ...
    /* Retreive the contact us message from the db */
        if(($_GET['id'] && $_GET['id']>0)){
            ...
            /* Get the current message using message id */
	        	...
	        	echo '<script>window.location = "'. URL .'views/ContactUsMessage-chat.php";</script>';
	        }
                        ...
                        <div class="aside-content">
                            ...
                            <div class="aside-nav collapse">
                                <ul class="nav">
                                    ...
                                    <li><a href="<?php echo URL;?>adminDashboard/concept-master/ContactUsMessage-chat.php"><span class="icon"><i class="fas fa-fw fa-inbox"></i></span>New Messages<span class="badge badge-primary float-right" id="numbOfNewMess"><?php echo $numbOfMess;?></span></a></li>
                                    <li><a href="<?php echo URL;?>adminDashboard/concept-master/ContactUsMessage-chat.php?a_ID=<?php echo $currentUserID;?>"><span class="icon"><i class="fas fa-fw  fa-envelope"></i></span>Your Replies<span class="badge badge-primary float-right" id="replyUpdate"><?php echo $totalReplyCount;?></span></a></li>
                                ...
                                <div class="avatar">
                                    <?php 
                                        if($getMess['iLoginID'] == 'Visitor'){
                                            echo '<img alt="Avatar" src="' . URL . 'img/gsStickerBig1.png" class="rounded-circle user-avatar-md aProfPic">';
                                        }
                                        else{
                                            echo '<img alt="Avatar" src="' . URL . 'upload/' . $getMess['sUsertype'] . '/' . $getMess['pic']. '" class="rounded-circle user-avatar-md aProfPic">';
                                        }
                                    ?>
                                </div>
                                <div class="sender"><a href="<?php if($getMess['iLoginID'] == 'Visitor'){echo '#';}else{echo URL . 'views/artistprofile.php?artist=' . $getMess['iLoginID'];}?>"><?php echo $getMess['sFullName'];?></a>
                    ...
                    sendReply.onreadystatechange = function(){
                        if(sendReply.status == 200 && sendReply.readyState == 4){
                            $('#replyUpdate').html(sendReply.responseText);
                             var numbOfNewMess = parseInt($('#numbOfNewMess').html());
    			     numbOfNewMess = numbOfNewMess - 1; 
    			     $('#numbOfNewMess').html(numbOfNewMess);
