<?php 
    /* Include Admin top and side navigation */
        ...
        /* Find the current Artist */
            ...
            foreach($getUser['church'] as $currentUser){
                if($currentUser['iLoginID'] == $u_ID){
        ...
        /* Get church's ministries */
            $getMinistryQuery = 'SELECT *
                               FROM churchministrymaster2
                               WHERE iLoginID = ?';

            try{
                $getMinistry = $db->prepare($getMinistryQuery);
                $getMinistry->bindParam(1, $u_ID);
                $getMinistry->execute(); 
                $getMinistryResults = $getMinistry->fetchAll(PDO::FETCH_ASSOC);
            }
            catch(Exception $e){
                echo $e; 
            }
        /* END - Get church's Ministries */

        /* Query the database for the videos of the current church */
            $query1 = 'SELECT churchvideomaster.*, giftmaster1.sGiftName
                      ...
                      WHERE churchvideomaster.iLoginID = ? AND churchvideomaster.removedStatus = 0
                    ';
            try{
        ...
        /* END - Query the database for the videos of the current church */

        /* Organize videos according to the ministry they display */
            foreach($result as $eachVid){
                $ministryArray[] = $eachVid['sGiftName'];
            }
            $ministryArray = array_unique($ministryArray);
            
            foreach($ministryArray as $eachMinistry){
                foreach($result as $eachVid1){
                    if($eachVid1['sGiftName'] == $eachMinistry){
                        $minSectArray[$eachMinistry][] = $eachVid1; 
                    }
                }
            }
        /* END - Organize videos according to the ministry they display */
            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <?php
                                    // echo '<pre>';
                                    // var_dump($getMinistryResults); 
                                    // var_dump($inActiveCount); 
                                    // var_dump($cancelledGigs); 
                            ?>
                            <h2 class="pageheader-title"><?php echo $userFound['sChurchName'];?></h2>
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">
                                            <?php 
                                                if($userFound['isActive'] == 1){ 
                                                    echo '<a href="' . URL . 'adminDashboard/concept-master/manageusers-churches.php?act=1" class="breadcrumb-link">';
                                                    echo 'Active Church';
                                                }else{
                                                    echo '<a href="' . URL . 'adminDashboard/concept-master/manageusers-churches.php?act=0" class="breadcrumb-link">';
                                                    echo 'Inactive Church';
                                                }
                                                echo '</a>';
                                            ?>
                                        </li>
                                        <li class="breadcrumb-item active" aria-current="page"><?php echo $userFound['sChurchName'];?> </li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="card ">
                                ...
                                <!-- Artist's profile pic -->
                                    <div class="container text-center text-md-left pl-md-4 mt-2">
                                        <img class="aProfPic" src="<?php echo $userFound['sProfileName'];?>" height="100px" width="100px">
                                    </div>
                                    <div class="container text-center text-md-left pl-md-4 mt-2">
                                        <a class="font-weight-bold text-gs" href="<?php echo URL;?>views/churchprofile.php?church=<?php echo $u_ID;?>">View Profile</a>
                                    </div>
                                <!-- /Artist's profile pic -->
                                <div class="card-body">
                                    <div class="container">
                                        ...
                                        <div class="row">
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $userFound['sPastorFirstName'];?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Pastor Last Name: </th>
                                                            <td><?php echo $userFound['sPastorLastName'];?></td>
                                                        </tr>
                                                        <tr>
                                                            <?php 
                                                                $dob = date_create($userFound['dDOB']);
                                                        ...
                                                        <tr>
                                                            ...
                                                            ?>
                                                            <th scope="row">Pastor Age: </th>
                                                            <td><?php echo $from->diff($to)->y; ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Pastor Gender: </th>
                                                            <td><?php echo $userFound['sGender'];?></td>
                                                        </tr>
                                                         <tr>
                                                            <?php 
                                                                $jDate = date_create($userFound['joinDate']);
                                            ...
                                            <div class="col col-md-6">
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <th scope="row">Church Phone #: </th>
                                                            <td>
                                                                <?php 
                                                                    if($userFound['sContactNumber'] != '') {
                                                                        /* The substr_replace() method is used to insert '-' into the phone numbers to make them more */
                                                                            $churchContact = $userFound['sContactNumber'];
                                                                            $churchContact1 = substr_replace($churchContact, '-', 3, 0);
                                                                            $churchContact2 = substr_replace($churchContact1, '-', 7, 0);
                                                                            echo $churchContact2;
                                                                    }
                                                                    else{
                                                                        echo 'N/A';
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $userFound['sContactEmailID'];?></td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">Street Address: </th>
                                                            <td><?php echo $userFound['sAddress'];?></td>
                                                        </tr>
                                                        <tr>
                                                            <?php 
                                                                $today = date_create($userFound['dDOB']);
                                                                $dob = date_format($today, "m-d-Y"); 
                                                            ?>
                                                            <th scope="row">City: </th>
                                                            <td><?php echo $userFound['sCityName'];?></td>
                                                        </tr>
                                                         <tr>
                                                            <th scope="row">State: </th>
                                                            <td><?php echo $userFound['name'];?></td>
                                                        </tr>
                                                         <tr>
                                                            <th scope="row">Zip Code: </th>
                                                            <td><?php echo $userFound['iZipcode']; ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                ...
                <div class="row">
                    ...
                    <!-- ============================================================== -->
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Profile Admin Info</h5>
                                <div class="card-body table-responsive">
                                    <table class="table"> 
                                        <tbody>
                                            <tr>
                                                <th scope="row">First Name:</th>
                                                <td><?php echo $userFound['sFirstName'];?></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Last Name: </th>
                                                <td><?php echo $userFound['sLastName'];?></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Login Email:</th>
                                                <td><?php echo $userFound['sEmailID'];?></td>
                                                <td></td>
                                            </tr> 
                                             <tr>
                    ...
                    <!-- ============================================================== -->
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Church Ministries</h5>
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php 
                                                $i = 1; 
                                                foreach($getMinistryResults as $cTalent){  
                                            ?>
                                                    <tr>
                                                        <th scope="row" style="width:10px;" ><?php echo $i;?></th>
                                                        <td><?php echo str_replace('_', '/',$cTalent['sGiftName']);?></td>
                                                    </tr>
                                            <?php 
                                                    $i++; 
                                                }
                    ...
                    <!-- ============================================================== -->
                    <!-- end Display church's Ministries -->
                    <!-- ============================================================== -->
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class='py-3' colspan="2"><a href="<?php echo URL;?>adminDashboard/concept-master/adminedit-user-profile.php?u_type=<?php echo 'church';?>&id=<?php echo $u_ID;?>" class="p-2 mt-4 text-white bg-gs" style="margin-top:12px;font-size:14px;border-radius:2px">Edit Acct</a></td>
                                            </tr>
                                            <tr>
                                                <?php if($userFound['isActive'] == 1){ ?>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <!-- Modal Title -->
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLongTitle">Deactivate Church Account</h5>
                                      ...
                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <!-- <form action="" method="POST" name="photoAdd" enctype="multipart/form-data" id="confirmForm"> onclick="submitReset()"-->
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <p>Please confirm the Activation of this church account.</p>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                    ...
                                    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="delete" aria-hidden="true">
                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <!-- Modal Title -->
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLongTitle">Delete Church Account</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="formReset()">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                      ...
                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <!-- <form action="" method="POST" name="photoAdd" enctype="multipart/form-data" id="confirmForm"> onclick="submitReset()"-->
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <p>Please confirm the deletion of this church account.</p>
                    ...
                    <div class="row">
                        ...
                        <!-- ============================================================== -->
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Church's Videos</h5>
                                    ...
                                    <div class="card-body" style="max-height: 350px;overflow:scroll;">
                                        <?php 
                                            if(count($result) == 0){
                                                echo '<div class="container mt-2 text-center" id="bookme-choice"><h1 class="" style="color: rgba(204,204,204,1)">This Church Has Not Added Any Videos Yet!!!</h1></div>';
                                            }
                                            else{
                                                foreach($minSectArray as $TalentName => $vidArrays) { 
                                        ?>
                                                    <!-- Talent Containers -->
                                                        <div class="container">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6 text-right">
                                                                    <a class="anchor-styled" href="<?php echo URL;?>views/viewAllVid.php?tal=<?php echo $TalentName;?>&churchID=<?php echo $u_ID; ?>">View All</a>
                                                                </div>
                                                            </div>
                                                            <!-- Card Rows -->
                                                            <div class="row">
                                                                 ...
                                                                 ?> 
                                                                            <!-- Card Content -->
                                                                                <div class="card col-7 p-4 col-md-2 p-md-4 border-light mx-auto mx-md-0">
                                                                                    <a href="<?php echo URL; ?>views/videoDisplay.php?vid_id=<?php echo $eachVidArray['id']; ?>&churchID=<?php echo $u_ID;?>&tal=<?php echo $TalentName; ?>">
                                                                                  ...
                                                                                  <div>
                                                                                        ...
                                                                                        <a href="#" class="getVidInfo" style="display:block" vidPath="<?php echo $eachVidArray['videoPath'];?>"  thumbPath="<?php echo $eachVidArray['videoThumbnailPath'];?>" vidID="<?php echo $eachVidArray['id'];?>"  data-toggle="modal" data-target="#deleteVid">Delete Video</a>
                                                                                  </div>
                                                                                </div>
                                                                            <!-- /Card Content -->
                                                                <?php   
                                                ...
                                                <!-- Modal Body -->
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="u_type" value="church">
                                                            <input type="hidden" name="adminID" value="<?php echo $currentUserID;?>">
                                                            <input type="hidden" name="iLoginID" value="<?php echo $u_ID;?>">
                                          ...
                                          <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <!-- <form action="" method="POST" name="photoAdd" enctype="multipart/form-data" id="confirmForm"> onclick="submitReset()"-->
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" id="confVidRemoval" data-dismiss="modal" aria-label="Close">Confirm</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Church's Photos</h5>
                                <div class="card-body" style="max-height: 350px;overflow:scroll;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Church's Events</h5>
                                <div class="card-body">
    ...
    <script>
        ...
        /* Deactivate users account */
            $('#confDeactivate').click(function(event){
                ...
                sendDeact.open('POST','/adminDashboard/concept-master/adminDeact-acct.php');
        ...
        /* Activate User's Account */
            $('#confActivate').click(function(event){
                ...
                sendAct.open('POST','/adminDashboard/concept-master/adminDeact-acct.php');
        ...
        /* Create the fetchGigs Function */
            function fetchGigs(selection1, selection2, userId){
               ...
               getGig.open('GET', '/adminDashboard/concept-master/adminGet-gig-event.php?sel1='+selection1+'&sel2='+selection2+'&u_ID='+userId);
               getGig.send();
           }
        ...
        /* Fetch Video Flags */
            $('.fetchFlags').click(function(event){
                ...
                if(numbFlags > 0){
                    ...
                    getFlags.open('GET', '/adminDashboard/concept-master/adminGet-vidFlags.php?u_ID='+userId+'&vid_ID='+vid_ID);
                    getFlags.send();
                }
            });
        ...
        /*************************** Delete Videos ***************************/
            ...
            $('#confVidRemoval').click(function(event){
                ...
                sendDelForm.open('post','<?php echo URL;?>views/fileUpload.php');
