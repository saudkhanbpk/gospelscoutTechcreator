...
?>
			...
			<div class="container bg-white mt-5 p-4" style="max-width: 900px;min-height:400px">
				...
				<div class="container mt-3">
					<h6><a class="text-gs font-weight-bold" href="<?php echo URL;?>adminDashboard/concept-master/manageusers-artists-details.php?u_ID=<?php echo $user_id;?>"><- Admin Page</a></h6>
				</div>				
				<!-- Personal Info Form -->
							...
							<div class="container mt-3"> <!-- Common Section -->	<input type="hidden" name="table" value="">
								<form name="churchInfo" class="needs-validation" novalidate>
									...
									<div class="row pl-2">
										...
										<div class="col-7 col-md-3">
											<img class="artist-vid-img" src="<?php if( $userData['sProfileName'] ==''){echo URL . 'img/gsStickerBig1.png';}else{echo URL . 'upload/church/' . $userData['sProfileName'];}?>" height="80px" alt="Card image cap" style="object-fit:cover; object-position:0,0;">
										</div>
									</div>
									<div class="row pl-2">
										<div class="col-10 col-md-7">
									...
									if(updateSection.responseText != ''){
									    ...
									    /* Only fade out the successful update messages */	
									    	if(response === 'Your Account Has Been Updated!!!' || response === 'Your Password Has Been Updated!!!'){
										    	$("#acct-update-message").fadeOut(3000);
										    	 setTimeout(function(){ window.location.href = 'https://www.gospelscout.com/adminDashboard/concept-master/adminedit-aritst-profile.php?u_type=<?php echo $user_type;?>&id=<?php echo $user_id;?>';},3100);
										    }
									}
							}
						}
