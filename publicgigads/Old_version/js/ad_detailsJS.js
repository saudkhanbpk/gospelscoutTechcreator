 ...
 ***********************************************/
 $('.getGigTalInqu').click(function(event){
    ...
    /* Get all artist inquiries on page load */
        ...
        get_tal_inquiries.open('get','https://www.stage.gospelscout.com/publicgigads/phpBackend/connectToDb_ad_details.php?get_all_inqu='+gigId+'&kjkjk&tal_type='+artistType);
