...
function submitFormData(page_no, id) {
	...
	// Create AJAX Request 
		var url = 'https://www.stage.gospelscout.com/artist/phpBackend/connectToDb_new.php'; 
 ...
 ******************************************************/
 function build_artists_modals(parsedResponse){console.log(parsedResponse);
	  ...
	  for( y in value){
			  ...
			  new_owl_div += '<div id="artistThumbs" style="position:relative; background-image: linear-gradient(rgba(0,0,0,.1), rgba(0,0,0,.6)), url(https://www.stage.gospelscout.com'+value[y][0].sProfileName+');">';
			  ...
			  new_owl_div += '<a class="addArtist" email="'+value[y][0].sContactEmailID+'" talent="'+value[y][0].talent+'" artistType="'+value[y][0].TalentID+'" iLoginID="'+value[y][0].iLoginID+'" fname="'+value[y][0].sFirstName+'" href="#" style="position: absolute; bottom:5px; right: 30px; font-size:.8em;"><img src="https://www.stage.gospelscout.com/publicgigads/css/person-fill-add.svg"></a>'; 
			  new_owl_div += '<a target="_blank" href="https://www.stage.gospelscout.com/views/artistprofile.php?artist='+value[y][0].iLoginID+'" style="position: absolute; bottom:5px; right: 5px; font-size:.8em;"><img src="https://www.stage.gospelscout.com/publicgigads/css/eye-fillIcon.svg"></a>';
			  new_owl_div += '</div>';
	  /* Modal: Name */
	  new_owl_div += '<div class="modal fade" id="modal-'+value[y][0].TalentID+'-user_'+value[y][0].iLoginID+'-'+y+'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog modal-dialog-centered" role="document"><div class="modal-content">';
			...
			new_owl_div += '<div class="modal-body mb-0 p-0"><div class="container">';
				  ...
				  /* Display profile image */
					new_owl_div += '<img class="z-depth-1" src="https://www.stage.gospelscout.com'+value[y][0].sProfileName+'"  width="100%" height="150" style="object-fit:cover; object-position:0,0;border-radius:3px 0 0 0;">';
			...
			/* Footer */
			new_owl_div += '<div class="modal-footer justify-content-center"><a type="button" target="_blank" href="https://www.stage.gospelscout.com/views/artistprofile.php?artist='+value[y][0].iLoginID+'" class="btn btn-gs btn-rounded btn-md ml-4">View Profile</a><button type="button" class="btn btn-outline-primary btn-rounded btn-md ml-4" data-dismiss="modal">Close</button></div>';
