						...
						/* Create functions */
							...
							/* Send Notifications to newly requested artists */
								if( $post_art_req ){
									$action = 'gigRequest';  
									$link = $post['gigId']; 
									$actionUrl = 'https://www.stage.gospelscout.com/publicgigads/ad_details.php?g_id='.$link;
									$requestorUrl = 'https://www.stage.gospelscout.com/views/artistprofile.php?artist='.$post['gigManLoginId'];
