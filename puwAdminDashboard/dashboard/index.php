...
?>
                                            ...
                                            <ul class="traffic-sales list-group list-group-flush">
                                                <?php foreach($allArtists as $artist){?>
                                                    <li class="traffic-sales-content list-group-item ">
                                                        <a href="<?php echo URL;?>views/artistprofile.php?artist=<?php echo $artist['iLoginID'];?>" target="_blank"><span class="traffic-sales-name"><?php echo truncateStr($artist['sFirstName'].' '.$artist['sLastName'], 12);?></span></a><span class="traffic-sales-amount"><?php echo $artist['sCityName'].', '.$artist['statecode'];?><?php if($artist['approved']){echo '<span class="icon-circle-sm icon-box-md text-success p-2 ml-4 bg-success-light"><i class="fas fa-check"></i></span>'; }else{echo '<button class=" ml-3 btn-sm bg-gs text-white d-none d-md-inline">Approve Artist</button>';}?></span><!--<span class="icon-circle-small icon-box-xs text-success ml-4 bg-success-light"><i class="fa fa-fw fa-arrow-up"></i></span>-->
                                                    </li>
                                                <?php }?>
                                            </ul>
                                        <?php }else{
              ...
              <form name="editEvent" id="editEvent" method="post" enctype="mulitpart/form-data">
                <div class="modal-body px-4 pt-2">
                    <div class="container p-0 mb-md-2 text-center"> 
                      ...
                      <div class="row text-center mb-0  px-md-5">
                        <div class="col-md-6 text-left">
                            <table class="table" style="font-size:12px">
                                <tbody>
                                    <tr>
                                        <th>First Name:</th>
                                        <td class="eventHost pl-2" id="host_fname"></td>
                                    </tr>
                                    <tr>
                                        <th>Last Name:</th>
                                        <td class="eventHost pl-2" id="host_lname"></td>
                                    </tr>
                                    <tr>
                                        <th>Email:</th>
                                        <td class="eventHost pl-2" id="host_email"></td>
                                    </tr>
                                    <tr>
                                        <th>Phone #:</th>
                                        <td class="eventHost pl-2" id="host_phone"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <table class="table" style="font-size:12px">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="eventHost pl-2" id="host_address"></td>
                                    </tr>
                                    <tr>
                                        <th>City:</th>
                                        <td class="eventHost pl-2" id="host_sCityName"></td>
                                    </tr>
                                    <tr>
                                        <th>State:</th>
                                        <td class="eventHost pl-2" id="name"></td>
                                    </tr>
                                    <tr>
                                        <th>Zip Code:</th>
                                        <td class="eventHost pl-2" id="host_zip"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="row text-center mb-4">
                        <div class="col-md-10 mx-auto text-left">
                          ...
                          <label class="text-gs mb-1" style="font-size:12px;font-weight:bold" for="">Artists (<span id="artistNumb">0</span>)</label>
                          <div class="container">
                            <div class="row">
                                ...
                                <div class="col col-md-12 pt-2 my-4" id="addPuwArtist">
                                    <a class="btn-sm btn-gs " href="#">Add New Artist</a>
                                </div>
                            </div>
                          </div>
                      </div>
    ...
    <script src="<?php echo URL;?>puwAdminDashboard/dashboard/js/indexJS.js"></script>
</body>
