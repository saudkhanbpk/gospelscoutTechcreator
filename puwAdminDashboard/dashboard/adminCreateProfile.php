...
?>
	<style>
		...
		#thumb {
			...
			background-image: url("<?php echo URL; ?>newHomePage/img/dummy.jpg");
	...
	<!-- ============================================================== -->
            ...
            <div class="container-fluid  dashboard-content">
                ...
                <form name="admnProfCreate" id="admnProfCreate" method="post" action="" enctype="multipart/form-data" autocomplete="off">
		                                            ...
		                                            <div class="col col-md-6">
		                                                <table class="table">
		                                                    <tbody>
		                                                        ...
		                                                        <tr>
    																<link rel="stylesheet" href="<?php echo URL; ?>Composer1/vendor/twbs/bootstrap/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
																    ...
																    ?>
		                                                        	<th scope="row">Artist Type:</th>
		                                                        	<td id="userTypeSect">
		                                                        		<label class="custom-control custom-radio">
							                                                <input type="radio" name="loginmaster[sUserType]" value="artist" id="soloSelection" class="custom-control-input showDepInput"><span class="custom-control-label">Solo Artist</span>
							                                            </label>
							                                            <table>
										                                    <tr>
										                                        <td>
									                                                <select class="custom-select dropdown py-0 my-0 d-none" id="u_typeSelectMen" name="talentmaster[TalentID]" style="height: 30px;font-size: 14px;font-color:rgba(0,0,0,.01);">
							                                            ...
							                                            <label class="custom-control custom-radio custom-control-inline">
							                                                <input type="radio" name="loginmaster[sUserType]" value="group" id="groupSelection" class="custom-control-input showDepInput"><span class="custom-control-label">Artist Group</span>
							                                            </label>
							                                             <table>
										                                    <tr>
										                                        <td>
							                                            			<input type="text" class="form-control form-control-sm clearDefault my-0 d-none" id="groupName" name="usermaster[sGroupName]" placeholder="Name of Group" value=""/> 
							                                            		</td>
																			</tr>
																		</table>
		                                                        	</td>
		                                                        ...
		                                                        <tr>
		                                                        	<th scope="row">Upload Artist's Img: </th>
		                                                            <td>
			                                                            <div class="container">
									                                        <div class="row">
													    						<div class="col-12 col-md-3">
	            	...
	            	<div class="container text-danger">
                		<p id="error-message" class="font-weight-bold"></p>
                	</div>
	            	<button class="mt-1" type="submit">Create Profile</button>
	            </form>
	    ...
	    <script src="<?php echo URL;?>newHomePage/js/adminCreateProfile.js"></script>
	    <script>
