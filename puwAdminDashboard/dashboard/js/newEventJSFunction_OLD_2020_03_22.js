/* New Event JavaScript function page */
    ...
    function insertArtists(stateArtists){
        ...
        /* Build Html */
            codeInsert = '<table class="table text-center">';
            ...
            for(artist in stateArtists){
               ...
               codeInsert += '<tr><td class="d-none d-md-table-cell"><a class="text-gs" target="_blank" href="https://www.stage.gospelscout.com/views/artistprofile.php?artist='+stateArtists[artist].iLoginID+'">'+stateArtists[artist].iLoginID+'</a></td><td><a class="text-gs" target="_blank" href="https://www.stage.gospelscout.com/views/artistprofile.php?artist='+stateArtists[artist].iLoginID+'">'+stateArtists[artist].sFirstName+'</a></td><td><a class="text-gs" target="_blank" href="https://www.stage.gospelscout.com/views/artistprofile.php?artist='+stateArtists[artist].iLoginID+'">'+stateArtists[artist].age+'</a></td><td><a class="text-gs" target="_blank" href="https://www.stage.gospelscout.com/views/artistprofile.php?artist='+stateArtists[artist].iLoginID+'">'+stateArtists[artist].talent+'</a></td><td><button class="btn btn-sm btn-gs '+theProperClass+'" artist_id="'+stateArtists[artist].iLoginID+'" artist_name="'+stateArtists[artist].sFirstName+'" artist_age="'+stateArtists[artist].age+'" artist_talent="'+stateArtists[artist].talent+'">'+theInnerHtml+'</button></td></tr>';
            }
