...
*************************/
	...
	var dropzone = new Dropzone(
		'#demo-upload', 
		{	
			url: 'https://www.gospelscout.com/popupworship/phpBackend/connectToDb.php',
			paramName: 'hostImgs',
			uploadMultiple: true,
			// chunking: true,
...
*************************/
	$('.getHost').click(function(event){
		...
		/* Get Host info */
			...
			host_xhr.open('get', 'https://www.gospelscout.com/puwAdminDashboard/dashboard/phpBackend/connectToDb.php?host_info='+host_id);
			host_xhr.send(); 
...
*************************/
	...
	$('#confirmDeleteHost').click(function(event){
		...
		/* Create new XMLHttpRequest() */
			...
			delHost_xhr.open('post','https://www.gospelscout.com/puwAdminDashboard/dashboard/phpBackend/connectToDb.php'); //?delete_host=true&hostID_del='+hostID_del
