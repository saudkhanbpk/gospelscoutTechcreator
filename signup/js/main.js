 ...
 function sendConfCode(){
    ...
    emailConfXhr.open('post','https://wwww.stage.gospelscout.com/signup/phpBackend/connectToDb.php');
...
function submitForm(){
    ...
    xhr.open('post','https://www.stage.gospelscout.com/signup/phpBackend/connectToDb.php');
    xhr.send(formOBJ);
}
   ...
   var test =  $("#form-total").steps({
        ...
        onFinishing: function (event, currentIndex) { 
            ...
            /* check confirmation code */
                ...
                checkConfxhr.open('get',`https://www.stage.gospelscout.com/signup/phpBackend/connectToDb.php?conf_code=${confCode}`);
                checkConfxhr.send();
