<!-- <!DOCTYPE html>-->
<?php require_once(realpath($_SERVER['DOCUMENT_ROOT']) . "/home/include/header.php"); ?>
<!--<html>-->
<head>
	<meta charset="utf-8">
		        	...
		        	<div id="form-total">
				                		...
				                		<div class="container p-0 my-0 mx-auto">
 											<div class="row m-0 p-0">
						                		<div class="col-1 pl-0">
		 											<input type="radio"  name="user-type" id="solo-type" class="solo-type u-type" value="solo-type">
		 										</div>
				                	...
				                	<div class="form-row pl-md-5 pt-2">
					                	...
					                	<!-- <div class="accordion accordion-flush" id="accordionFlushExample">
 										...
 										<div class="container p-0 my-0 mx-auto">
 											<div class="row m-0 p-0">
		 										<div class="col-1 pl-0">
		 											<input type="radio" name="user-type" id="group-type" class="band-type u-type" value="band-type">
		 										</div>
			            ...
			            <section class="sect-2">
			                <div class="inner">
								...
								<div class="container text-center my-0" id="validation-error"></div><!--<button type='button'  onclick="sendConfCode()">test</button>-->
							</div>
			            </section>
