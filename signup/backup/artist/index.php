	...
	/* Check if user is signed in - if so, redirect user to their profile page */
		...
		if($currentUserID != ''){
			if($currentUserType == 'artist' || $currentUserType == 'group'){
				echo '<script>window.location = "'. URL .'newHomePage/views/artistprofile.php";</script>';
				exit;
			}
			elseif($currentUserType == 'church'){
				echo '<script>window.location = "'. URL .'newHomePage/views/churchprofile.php";</script>';
				exit;
			}
		}
		else{
...
<!-- Dropzone.js file upload plugin -->
    <link href="<?php echo URL; ?>newHomePage/node_modules/dropzone/dist/dropzone.css" rel="stylesheet">
    <script src="<?php echo URL;?>newHomePage/node_modules/dropzone/dist/dropzone.js"></script>

<!-- <div id="carouselExampleIndicators" class="carousel mb-2 pt-0 pb-0 mt-5 text-center valid-form-check bg-bg2" style="background-image: url(https://dev.gospelscout.com/newHomePage/img/BusinessCardCollage2.png);" data-wrap="false" data-interval="false" data-ride="false">  -->
	<div class="masthead">
				...
				<form  method="post" name="artist-signup" id="artist-signup" enctype="multipart/form-data" autocomplete="off">
					...
					<!-- Slide 2 -->
					    <div class="carousel-item bg-transparent mb-2" id="step2" style="min-height:400px;height:auto;">
					    	<div class="container pt-2">
					    		<div class="row pt-3 justify-content-center">
					    			<div class=" col col-md-5 text-center bg-white pt-2 pb-5 signup-steps" style="max-height: 475px;overflow:scroll;">
									    ...
									    <!-- <div class="container text-left">
										    ...
										    <div class="container">
											    <ul class="mt-0" style="font-size: 12px">
											    	<li>I have read and accepted the <a href="<?php echo URL;?>newHomePage/views/terms.php" target="_blank" class="text-gs">Terms of Use</a> and <a href="#" class="text-gs">Privacy Policy</a></li>
											    </ul>
											</div>
										</div> -->
					    	...
					    	<div class="container pt-2">
					    		<div class="row pt-3 justify-content-center">
					    			<div class=" col col-md-5 bg-white text-center pt-3 pb-5 signup-steps" style="max-height: 475px;overflow:scroll;">
										...
										<div class="container">
						    				 <img class="featurette-image img-fluid mx-auto" src="<?php echo URL;?>newHomePage/img/powered_by_stripe.png" width="100" height="50" data-src="" alt="Generic placeholder image">
						    			</div>
										<div id="confCodeError" class="container d-none"></div>
					      			</div>
						      	</div>
...
<!--<script src="<?php echo URL;?>newHomePage/js/jsFunctions.js"></script> -->
<script src="<?php echo URL;?>newHomePage/js/artistJS.js"></script>
