function sendConfCode(){
    ...
    if(email_is_present != ''){
        ...
        // sendMail.open("POST", "https://www.gospelscout.com/signup/gen_user/phpBackend/emailConf.php");
        ...
        /* Set validation rules & corresponding error-messages */
             rules:{
                ...
                'loginmaster[sEmailID]': {
                     ...
                     email: true,
                     remote:({
                         url: 'https://www.gospelscout.com/signup/gen_user/phpBackend/connectToDb.php' ,
                        //  success: (resp) => {
                        //     console.log(resp)
                        //  }
                     })
   ...
   var test =  $("#form-total").steps({
        ...
        onFinishing: function (event, currentIndex) { 
            ...
            /* handle form submission - AJAX Request */
                ...
                xhr.open('post','https://www.gospelscout.com/signup/gen_user/phpBackend/connectToDb.php');
                xhr.send(formOBJ);
        },
    })
